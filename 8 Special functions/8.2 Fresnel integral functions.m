...
{x^2*FresnelS[d*(a + b*Log[c*x^n])], x, 14, ((1/12 - I/12)*E^((-3*a)/(b*n) + ((9*I)/2)/(b^2*d^2*n^2*Pi))*x^3*Erf[((1/2 + I/2)*(3/n + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(c*x^n)^(3/n) + ((1/12 - I/12)*E^((-3*a)/(b*n) - ((9*I)/2)/(b^2*d^2*n^2*Pi))*x^3*Erfi[((1/2 + I/2)*(3/n - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(c*x^n)^(3/n) + (x^3*FresnelS[d*(a + b*Log[c*x^n])])/3}
{x^1*FresnelS[d*(a + b*Log[c*x^n])], x, 14, ((1/8 - I/8)*E^((2*I - 2*a*b*d^2*n*Pi)/(b^2*d^2*n^2*Pi))*x^2*Erf[((1/2 + I/2)*(2/n + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(c*x^n)^(2/n) + ((1/8 - I/8)*x^2*Erfi[((1/2 + I/2)*(2/n - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*(I + a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*(c*x^n)^(2/n)) + (x^2*FresnelS[d*(a + b*Log[c*x^n])])/2}
{x^0*FresnelS[d*(a + b*Log[c*x^n])], x, 14, ((1/4 - I/4)*x*Erf[((1/2 + I/2)*(n^(-1) + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*a*b*n - I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)) + ((1/4 - I/4)*x*Erfi[((1/2 + I/2)*(n^(-1) - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*a*b*n + I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)) + x*FresnelS[d*(a + b*Log[c*x^n])]}
{FresnelS[d*(a + b*Log[c*x^n])]/x^1, x, 3, Cos[(d^2*Pi*(a + b*Log[c*x^n])^2)/2]/(b*d*n*Pi) + (FresnelS[d*(a + b*Log[c*x^n])]*(a + b*Log[c*x^n]))/(b*n)}
{FresnelS[d*(a + b*Log[c*x^n])]/x^2, x, 14, ((1/4 - I/4)*E^((2*a*b*n + I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)*Erf[((1/2 + I/2)*(n^(-1) - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/x + ((1/4 - I/4)*E^((2*a*b*n - I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)*Erfi[((1/2 + I/2)*(n^(-1) + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/x - FresnelS[d*(a + b*Log[c*x^n])]/x}
{FresnelS[d*(a + b*Log[c*x^n])]/x^3, x, 14, ((1/8 - I/8)*E^((2*I + 2*a*b*d^2*n*Pi)/(b^2*d^2*n^2*Pi))*(c*x^n)^(2/n)*Erf[((1/2 + I/2)*(2/n - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/x^2 + ((1/8 - I/8)*(c*x^n)^(2/n)*Erfi[((1/2 + I/2)*(2/n + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*(I - a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*x^2) - FresnelS[d*(a + b*Log[c*x^n])]/(2*x^2)}


{(e*x)^m*FresnelS[d*(a + b*Log[c*x^n])], x, 16, ((1/4 - I/4)*E^(((I/2)*(1 + m)*(1 + m + (2*I)*a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*x*(e*x)^m*Erf[((1/2 + I/2)*(1 + m + I*a*b*d^2*n*Pi + I*b^2*d^2*n*Pi*Log[c*x^n]))/(b*d*n*Sqrt[Pi])])/((1 + m)*(c*x^n)^((1 + m)/n)) + ((1/4 - I/4)*x*(e*x)^m*Erfi[((1/2 + I/2)*(1 + m - I*a*b*d^2*n*Pi - I*b^2*d^2*n*Pi*Log[c*x^n]))/(b*d*n*Sqrt[Pi])])/(E^(((I/2)*(1 + m)*(1 + m - (2*I)*a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*(1 + m)*(c*x^n)^((1 + m)/n)) + ((e*x)^(1 + m)*FresnelS[d*(a + b*Log[c*x^n])])/(e*(1 + m))}
...
{x^2*FresnelC[d*(a + b*Log[c*x^n])], x, 14, ((1/12 + I/12)*E^((-3*a)/(b*n) + ((9*I)/2)/(b^2*d^2*n^2*Pi))*x^3*Erf[((1/2 + I/2)*(3/n + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(c*x^n)^(3/n) - ((1/12 + I/12)*E^((-3*a)/(b*n) - ((9*I)/2)/(b^2*d^2*n^2*Pi))*x^3*Erfi[((1/2 + I/2)*(3/n - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(c*x^n)^(3/n) + (x^3*FresnelC[d*(a + b*Log[c*x^n])])/3}
{x^1*FresnelC[d*(a + b*Log[c*x^n])], x, 14, ((1/8 + I/8)*E^((2*I - 2*a*b*d^2*n*Pi)/(b^2*d^2*n^2*Pi))*x^2*Erf[((1/2 + I/2)*(2/n + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(c*x^n)^(2/n) - ((1/8 + I/8)*x^2*Erfi[((1/2 + I/2)*(2/n - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*(I + a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*(c*x^n)^(2/n)) + (x^2*FresnelC[d*(a + b*Log[c*x^n])])/2}
{x^0*FresnelC[d*(a + b*Log[c*x^n])], x, 14, ((1/4 + I/4)*x*Erf[((1/2 + I/2)*(n^(-1) + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*a*b*n - I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)) - ((1/4 + I/4)*x*Erfi[((1/2 + I/2)*(n^(-1) - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*a*b*n + I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)) + x*FresnelC[d*(a + b*Log[c*x^n])]}
{FresnelC[d*(a + b*Log[c*x^n])]/x^1, x, 3, (FresnelC[d*(a + b*Log[c*x^n])]*(a + b*Log[c*x^n]))/(b*n) - Sin[(d^2*Pi*(a + b*Log[c*x^n])^2)/2]/(b*d*n*Pi)}
{FresnelC[d*(a + b*Log[c*x^n])]/x^2, x, 14, ((1/4 + I/4)*E^((2*a*b*n + I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)*Erf[((1/2 + I/2)*(n^(-1) - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/x - ((1/4 + I/4)*E^((2*a*b*n - I/(d^2*Pi))/(2*b^2*n^2))*(c*x^n)^n^(-1)*Erfi[((1/2 + I/2)*(n^(-1) + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/x - FresnelC[d*(a + b*Log[c*x^n])]/x}
{FresnelC[d*(a + b*Log[c*x^n])]/x^3, x, 14, ((1/8 + I/8)*E^((2*I + 2*a*b*d^2*n*Pi)/(b^2*d^2*n^2*Pi))*(c*x^n)^(2/n)*Erf[((1/2 + I/2)*(2/n - I*a*b*d^2*Pi - I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/x^2 - ((1/8 + I/8)*(c*x^n)^(2/n)*Erfi[((1/2 + I/2)*(2/n + I*a*b*d^2*Pi + I*b^2*d^2*Pi*Log[c*x^n]))/(b*d*Sqrt[Pi])])/(E^((2*(I - a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*x^2) - FresnelC[d*(a + b*Log[c*x^n])]/(2*x^2)}


{(e*x)^m*FresnelC[d*(a + b*Log[c*x^n])], x, 16, ((1/4 + I/4)*E^(((I/2)*(1 + m)*(1 + m + (2*I)*a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*x*(e*x)^m*Erf[((1/2 + I/2)*(1 + m + I*a*b*d^2*n*Pi + I*b^2*d^2*n*Pi*Log[c*x^n]))/(b*d*n*Sqrt[Pi])])/((1 + m)*(c*x^n)^((1 + m)/n)) - ((1/4 + I/4)*x*(e*x)^m*Erfi[((1/2 + I/2)*(1 + m - I*a*b*d^2*n*Pi - I*b^2*d^2*n*Pi*Log[c*x^n]))/(b*d*n*Sqrt[Pi])])/(E^(((I/2)*(1 + m)*(1 + m - (2*I)*a*b*d^2*n*Pi))/(b^2*d^2*n^2*Pi))*(1 + m)*(c*x^n)^((1 + m)/n)) + ((e*x)^(1 + m)*FresnelC[d*(a + b*Log[c*x^n])])/(e*(1 + m))}
