...
{Sinh[c + d*x]^4*(a + b*Sinh[c + d*x]^4), x, 7, (1/128)*(48*a + 35*b)*x - ((80*a + 93*b)*Cosh[c + d*x]*Sinh[c + d*x])/(128*d) + ((48*a + 139*b)*Cosh[c + d*x]^3*Sinh[c + d*x])/(192*d) - (13*b*Cosh[c + d*x]^5*Sinh[c + d*x])/(48*d) + (b*Cosh[c + d*x]^3*Sinh[c + d*x]^5)/(8*d)}
{Sinh[c + d*x]^3*(a + b*Sinh[c + d*x]^4), x, 3, -(((a + b)*Cosh[c + d*x])/d) + ((a + 3*b)*Cosh[c + d*x]^3)/(3*d) - (3*b*Cosh[c + d*x]^5)/(5*d) + (b*Cosh[c + d*x]^7)/(7*d)}
{Sinh[c + d*x]^2*(a + b*Sinh[c + d*x]^4), x, 6, (-(1/16))*(8*a + 5*b)*x + ((8*a + 11*b)*Cosh[c + d*x]*Sinh[c + d*x])/(16*d) - (3*b*Cosh[c + d*x]^3*Sinh[c + d*x])/(8*d) + (b*Cosh[c + d*x]^3*Sinh[c + d*x]^3)/(6*d)}
...
{Sinh[c + d*x]^2*(a + b*Sinh[c + d*x]^4)^2, x, 10, (-(1/256))*(128*a^2 + 160*a*b + 63*b^2)*x + ((128*a^2 + 352*a*b + 193*b^2)*Cosh[c + d*x]*Sinh[c + d*x])/(256*d) - (b*(96*a + 65*b)*Cosh[c + d*x]^3*Sinh[c + d*x])/(128*d) + (b*(32*a + 63*b)*Cosh[c + d*x]^3*Sinh[c + d*x]^3)/(96*d) - (33*b^2*Cosh[c + d*x]^5*Sinh[c + d*x]^3)/(80*d) + (b^2*Cosh[c + d*x]^7*Sinh[c + d*x]^3)/(10*d)}
...
{Sinh[c + d*x]^2*(a + b*Sinh[c + d*x]^4)^3, x, 14, -(((1024*a^3 + 1920*a^2*b + 1512*a*b^2 + 429*b^3)*x)/2048) + ((1024*a^3 + 4224*a^2*b + 4632*a*b^2 + 1619*b^3)*Cosh[c + d*x]*Sinh[c + d*x])/(2048*d) - (b*(1152*a^2 + 1560*a*b + 595*b^2)*Cosh[c + d*x]^3*Sinh[c + d*x])/(1024*d) + (b*(384*a^2 + 1512*a*b + 941*b^2)*Cosh[c + d*x]^3*Sinh[c + d*x]^3)/(768*d) - (11*b^2*(72*a + 89*b)*Cosh[c + d*x]^5*Sinh[c + d*x]^3)/(640*d) + (3*b^2*(56*a + 207*b)*Cosh[c + d*x]^7*Sinh[c + d*x]^3)/(560*d) - (73*b^3*Cosh[c + d*x]^9*Sinh[c + d*x]^3)/(168*d) + (b^3*Cosh[c + d*x]^11*Sinh[c + d*x]^3)/(14*d)}
