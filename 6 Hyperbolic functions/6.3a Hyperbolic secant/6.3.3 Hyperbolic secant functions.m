...
{Tanh[c + d*x]^5*Sqrt[a + b*Sech[c + d*x]], x, 6, (2*Sqrt[a]*ArcTanh[Sqrt[a + b*Sech[c + d*x]]/Sqrt[a]])/d - (2*Sqrt[a + b*Sech[c + d*x]])/d + (2*a*(a^2 - 2*b^2)*(a + b*Sech[c + d*x])^(3/2))/(3*b^4*d) - (2*(3*a^2 - 2*b^2)*(a + b*Sech[c + d*x])^(5/2))/(5*b^4*d) + (6*a*(a + b*Sech[c + d*x])^(7/2))/(7*b^4*d) - (2*(a + b*Sech[c + d*x])^(9/2))/(9*b^4*d)}
