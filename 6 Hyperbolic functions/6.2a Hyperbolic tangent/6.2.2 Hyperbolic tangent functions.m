...
{E^(a + b*x)*Tanh[a + b*x]^4, x, 8, E^(a + b*x)/b - (8*E^(3*a + 3*b*x))/(3*b*(1 + E^(2*a + 2*b*x))^3) + (2*E^(3*a + 3*b*x))/(b*(1 + E^(2*a + 2*b*x))^2) + (3*E^(a + b*x))/(b*(1 + E^(2*a + 2*b*x))) - (3*ArcTan[E^(a + b*x)])/b}
...
{E^(a + b*x)*Coth[a + b*x]^4, x, 8, E^(a + b*x)/b + (8*E^(3*a + 3*b*x))/(3*b*(1 - E^(2*a + 2*b*x))^3) - (2*E^(3*a + 3*b*x))/(b*(1 - E^(2*a + 2*b*x))^2) + (3*E^(a + b*x))/(b*(1 - E^(2*a + 2*b*x))) - (3*ArcTanh[E^(a + b*x)])/b}
