...
{(c + d*x)^3*Tanh[e + f*x], x, 6, -((c + d*x)^4/(4*d)) + ((c + d*x)^3*Log[1 + E^(2*(e + f*x))])/f + (3*d*(c + d*x)^2*PolyLog[2, -E^(2*(e + f*x))])/(2*f^2) - (3*d^2*(c + d*x)*PolyLog[3, -E^(2*(e + f*x))])/(2*f^3) + (3*d^3*PolyLog[4, -E^(2*(e + f*x))])/(4*f^4)}
{(c + d*x)^2*Tanh[e + f*x], x, 5, -((c + d*x)^3/(3*d)) + ((c + d*x)^2*Log[1 + E^(2*(e + f*x))])/f + (d*(c + d*x)*PolyLog[2, -E^(2*(e + f*x))])/f^2 - (d^2*PolyLog[3, -E^(2*(e + f*x))])/(2*f^3)}
{(c + d*x)^1*Tanh[e + f*x], x, 4, -((c + d*x)^2/(2*d)) + ((c + d*x)*Log[1 + E^(2*(e + f*x))])/f + (d*PolyLog[2, -E^(2*(e + f*x))])/(2*f^2)}
{Tanh[e + f*x]/(c + d*x)^1, x, 0, Unintegrable[Tanh[e + f*x]/(c + d*x), x]}
{Tanh[e + f*x]/(c + d*x)^2, x, 0, Unintegrable[Tanh[e + f*x]/(c + d*x)^2, x]}


{(c + d*x)^3*Tanh[e + f*x]^2, x, 7, -((c + d*x)^3/f) + (c + d*x)^4/(4*d) + (3*d*(c + d*x)^2*Log[1 + E^(2*(e + f*x))])/f^2 + (3*d^2*(c + d*x)*PolyLog[2, -E^(2*(e + f*x))])/f^3 - (3*d^3*PolyLog[3, -E^(2*(e + f*x))])/(2*f^4) - ((c + d*x)^3*Tanh[e + f*x])/f}
{(c + d*x)^2*Tanh[e + f*x]^2, x, 6, -((c + d*x)^2/f) + (c + d*x)^3/(3*d) + (2*d*(c + d*x)*Log[1 + E^(2*(e + f*x))])/f^2 + (d^2*PolyLog[2, -E^(2*(e + f*x))])/f^3 - ((c + d*x)^2*Tanh[e + f*x])/f}
{(c + d*x)^1*Tanh[e + f*x]^2, x, 3, c*x + (d*x^2)/2 + (d*Log[Cosh[e + f*x]])/f^2 - ((c + d*x)*Tanh[e + f*x])/f}
{Tanh[e + f*x]^2/(c + d*x)^1, x, 0, Unintegrable[Tanh[e + f*x]^2/(c + d*x), x]}
{Tanh[e + f*x]^2/(c + d*x)^2, x, 0, Unintegrable[Tanh[e + f*x]^2/(c + d*x)^2, x]}
...
{(c + d*x)^2*Tanh[e + f*x]^3, x, 9, (c*d*x)/f + (d^2*x^2)/(2*f) - (c + d*x)^3/(3*d) + ((c + d*x)^2*Log[1 + E^(2*(e + f*x))])/f + (d^2*Log[Cosh[e + f*x]])/f^3 + (d*(c + d*x)*PolyLog[2, -E^(2*(e + f*x))])/f^2 - (d^2*PolyLog[3, -E^(2*(e + f*x))])/(2*f^3) - (d*(c + d*x)*Tanh[e + f*x])/f^2 - ((c + d*x)^2*Tanh[e + f*x]^2)/(2*f)}
{(c + d*x)^1*Tanh[e + f*x]^3, x, 7, (d*x)/(2*f) - (c + d*x)^2/(2*d) + ((c + d*x)*Log[1 + E^(2*(e + f*x))])/f + (d*PolyLog[2, -E^(2*(e + f*x))])/(2*f^2) - (d*Tanh[e + f*x])/(2*f^2) - ((c + d*x)*Tanh[e + f*x]^2)/(2*f)}
{Tanh[e + f*x]^3/(c + d*x)^1, x, 0, Unintegrable[Tanh[e + f*x]^3/(c + d*x), x]}
{Tanh[e + f*x]^3/(c + d*x)^2, x, 0, Unintegrable[Tanh[e + f*x]^3/(c + d*x)^2, x]}
...
{x*Sqrt[a*Tanh[b*x]], x, -1, (1/(8*b^2*Sqrt[Tanh[b*x]]))*(-8*b*x*ArcTan[Sqrt[Tanh[b*x]]] + 4*I*ArcTan[Sqrt[Tanh[b*x]]]^2 - 4*ArcTan[Sqrt[Tanh[b*x]]]*Log[1 + (-I + Sqrt[Tanh[b*x]])^2/(I + Sqrt[Tanh[b*x]])^2] - 4*b*x*Log[1 - Sqrt[Tanh[b*x]]] + Log[4]*Log[1 - Sqrt[Tanh[b*x]]] - Log[1 - Sqrt[Tanh[b*x]]]^2 + 2*Log[1 - Sqrt[Tanh[b*x]]]*Log[(1/2 + I/2)*(-I + Sqrt[Tanh[b*x]])] + 4*b*x*Log[1 + Sqrt[Tanh[b*x]]] - Log[4]*Log[1 + Sqrt[Tanh[b*x]]] - 2*Log[(1/2)*((1 + I) - (1 - I)*Sqrt[Tanh[b*x]])]*Log[1 + Sqrt[Tanh[b*x]]] - 2*Log[(-(1/2) - I/2)*(I + Sqrt[Tanh[b*x]])]*Log[1 + Sqrt[Tanh[b*x]]] + Log[1 + Sqrt[Tanh[b*x]]]^2 + 2*Log[1 - Sqrt[Tanh[b*x]]]*Log[(1/2)*((1 + I) + (1 - I)*Sqrt[Tanh[b*x]])] + I*PolyLog[2, -((-I + Sqrt[Tanh[b*x]])^2/(I + Sqrt[Tanh[b*x]])^2)] - 2*PolyLog[2, (1/2)*(1 - Sqrt[Tanh[b*x]])] + 2*PolyLog[2, (-(1/2) - I/2)*(-1 + Sqrt[Tanh[b*x]])] + 2*PolyLog[2, (-(1/2) + I/2)*(-1 + Sqrt[Tanh[b*x]])] + 2*PolyLog[2, (1/2)*(1 + Sqrt[Tanh[b*x]])] - 2*PolyLog[2, (1/2 - I/2)*(1 + Sqrt[Tanh[b*x]])] - 2*PolyLog[2, (1/2 + I/2)*(1 + Sqrt[Tanh[b*x]])])*Sqrt[a*Tanh[b*x]]}


{(c + d*x)^2*Sqrt[b*Tanh[e + f*x]], x, 0, Unintegrable[(c + d*x)^2*Sqrt[b*Tanh[e + f*x]], x]}
{(c + d*x)^1*Sqrt[b*Tanh[e + f*x]], x, -1, (Sqrt[b]*(d*e - c*f)*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/f^2 - (Sqrt[b]*(d*e - c*f)*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/f^2 + ((d*Sqrt[b*Tanh[e + f*x]])/(8*f^2*Sqrt[Tanh[e + f*x]]))*(-8*(e + f*x)*ArcTan[Sqrt[Tanh[e + f*x]]] + 4*I*ArcTan[Sqrt[Tanh[e + f*x]]]^2 - 4*ArcTan[Sqrt[Tanh[e + f*x]]]*Log[1 + (-I + Sqrt[Tanh[e + f*x]])^2/(I + Sqrt[Tanh[e + f*x]])^2] - 4*(e + f*x)*Log[1 - Sqrt[Tanh[e + f*x]]] + Log[4]*Log[1 - Sqrt[Tanh[e + f*x]]] - Log[1 - Sqrt[Tanh[e + f*x]]]^2 + 2*Log[1 - Sqrt[Tanh[e + f*x]]]*Log[(1/2 + I/2)*(-I + Sqrt[Tanh[e + f*x]])] + 4*(e + f*x)*Log[1 + Sqrt[Tanh[e + f*x]]] - Log[4]*Log[1 + Sqrt[Tanh[e + f*x]]] - 2*Log[(1/2)*((1 + I) - (1 - I)*Sqrt[Tanh[e + f*x]])]*Log[1 + Sqrt[Tanh[e + f*x]]] - 2*Log[(-(1/2) - I/2)*(I + Sqrt[Tanh[e + f*x]])]*Log[1 + Sqrt[Tanh[e + f*x]]] + Log[1 + Sqrt[Tanh[e + f*x]]]^2 + 2*Log[1 - Sqrt[Tanh[e + f*x]]]*Log[(1/2)*((1 + I) + (1 - I)*Sqrt[Tanh[e + f*x]])] - 2*PolyLog[2, (1/2)*(1 - Sqrt[Tanh[e + f*x]])] + 2*PolyLog[2, (-(1/2) - I/2)*(-1 + Sqrt[Tanh[e + f*x]])] + 2*PolyLog[2, (-(1/2) + I/2)*(-1 + Sqrt[Tanh[e + f*x]])] + I*PolyLog[2, -((-I + Sqrt[Tanh[e + f*x]])^2/(I + Sqrt[Tanh[e + f*x]])^2)] + 2*PolyLog[2, (1/2)*(1 + Sqrt[Tanh[e + f*x]])] - 2*PolyLog[2, (1/2 - I/2)*(1 + Sqrt[Tanh[e + f*x]])] - 2*PolyLog[2, (1/2 + I/2)*(1 + Sqrt[Tanh[e + f*x]])])}
{Sqrt[b*Tanh[e + f*x]]/(c + d*x)^1, x, 0, Unintegrable[Sqrt[b*Tanh[e + f*x]]/(c + d*x), x]}


{(c + d*x)^2*(b*Tanh[e + f*x])^(3/2), x, 1, Unintegrable[(c + d*x)^2*(b*Tanh[e + f*x])^(3/2), x], -((2*b*(c + d*x)^2*Sqrt[b*Tanh[e + f*x]])/f) + b^2*Unintegrable[(c + d*x)^2/Sqrt[b*Tanh[e + f*x]], x] + (4*b*d*Unintegrable[(c + d*x)*Sqrt[b*Tanh[e + f*x]], x])/f}
{(c + d*x)^1*(b*Tanh[e + f*x])^(3/2), x, 6, -((2*b^(3/2)*d*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/f^2) + (2*b^(3/2)*d*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/f^2 - (2*b*(c + d*x)*Sqrt[b*Tanh[e + f*x]])/f + b^2*Unintegrable[(c + d*x)/Sqrt[b*Tanh[e + f*x]], x]}
{(b*Tanh[e + f*x])^(3/2)/(c + d*x)^1, x, 0, Unintegrable[(b*Tanh[e + f*x])^(3/2)/(c + d*x), x]}


{(c + d*x)^2*(b*Tanh[e + f*x])^(5/2), x, 7, Unintegrable[(c + d*x)^2*(b*Tanh[e + f*x])^(5/2), x], -((8*b^(5/2)*d^2*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(3*f^3)) + (8*b^(5/2)*d^2*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(3*f^3) - (8*b^2*d*(c + d*x)*Sqrt[b*Tanh[e + f*x]])/(3*f^2) - (2*b*(c + d*x)^2*(b*Tanh[e + f*x])^(3/2))/(3*f) + (4*b^3*d*Unintegrable[(c + d*x)/Sqrt[b*Tanh[e + f*x]], x])/(3*f) + b^2*Unintegrable[(c + d*x)^2*Sqrt[b*Tanh[e + f*x]], x]}
{(c + d*x)^1*(b*Tanh[e + f*x])^(5/2), x, 7, (2*b^(5/2)*d*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(3*f^2) + (2*b^(5/2)*d*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(3*f^2) - (4*b^2*d*Sqrt[b*Tanh[e + f*x]])/(3*f^2) - (2*b*(c + d*x)*(b*Tanh[e + f*x])^(3/2))/(3*f) + b^2*Unintegrable[(c + d*x)*Sqrt[b*Tanh[e + f*x]], x]}
{(b*Tanh[e + f*x])^(5/2)/(c + d*x)^1, x, 0, Unintegrable[(b*Tanh[e + f*x])^(5/2)/(c + d*x), x]}
...
{(c + d*x)^2/Sqrt[b*Tanh[e + f*x]], x, 0, Unintegrable[(c + d*x)^2/Sqrt[b*Tanh[e + f*x]], x]}
{(c + d*x)^1/Sqrt[b*Tanh[e + f*x]], x, -1, (c*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(Sqrt[b]*f) + (d*x*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(Sqrt[b]*f) + (I*d*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]]^2)/(2*Sqrt[b]*f^2) + (c*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(Sqrt[b]*f) + (d*x*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(Sqrt[b]*f) + (d*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]]^2)/(2*Sqrt[b]*f^2) - (d*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]]*Log[(2*Sqrt[b])/(Sqrt[b] - Sqrt[b*Tanh[e + f*x]])])/(Sqrt[b]*f^2) + (d*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]]*Log[(2*Sqrt[b])/(Sqrt[b] + I*Sqrt[b*Tanh[e + f*x]])])/(Sqrt[b]*f^2) + (d*Log[(Sqrt[-b] - Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] - Sqrt[b])]*Log[1 - Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(4*Sqrt[b]*f^2) + (d*Log[(Sqrt[-b] + Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] + Sqrt[b])]*Log[1 - Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(4*Sqrt[b]*f^2) + (I*d*Log[((1/2 - I/2)*(Sqrt[b] - Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]]*Log[1 - (I*Sqrt[b*Tanh[e + f*x]])/Sqrt[b]])/(4*Sqrt[b]*f^2) + (I*d*Log[((1/2 + I/2)*(Sqrt[b] + Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]]*Log[1 - (I*Sqrt[b*Tanh[e + f*x]])/Sqrt[b]])/(4*Sqrt[b]*f^2) - (I*d*Log[((1/2 + I/2)*(Sqrt[b] - Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]]*Log[1 + (I*Sqrt[b*Tanh[e + f*x]])/Sqrt[b]])/(4*Sqrt[b]*f^2) - (I*d*Log[((1/2 - I/2)*(Sqrt[b] + Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]]*Log[1 + (I*Sqrt[b*Tanh[e + f*x]])/Sqrt[b]])/(4*Sqrt[b]*f^2) - (d*Log[(Sqrt[-b] - Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] + Sqrt[b])]*Log[1 + Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(4*Sqrt[b]*f^2) - (d*Log[(Sqrt[-b] + Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] - Sqrt[b])]*Log[1 + Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(4*Sqrt[b]*f^2) + (d*PolyLog[2, -((Sqrt[b] - Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] - Sqrt[b]))])/(4*Sqrt[b]*f^2) + (d*PolyLog[2, (Sqrt[b] - Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] + Sqrt[b])])/(4*Sqrt[b]*f^2) + (I*d*PolyLog[2, ((1/2 - I/2)*(Sqrt[b] - I*Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]])/(4*Sqrt[b]*f^2) + (I*d*PolyLog[2, ((1/2 + I/2)*(Sqrt[b] - I*Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]])/(4*Sqrt[b]*f^2) - (I*d*PolyLog[2, ((1/2 - I/2)*(Sqrt[b] + I*Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]])/(4*Sqrt[b]*f^2) - (I*d*PolyLog[2, ((1/2 + I/2)*(Sqrt[b] + I*Sqrt[b*Tanh[e + f*x]]))/Sqrt[b]])/(4*Sqrt[b]*f^2) - (d*PolyLog[2, -((Sqrt[b] + Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] - Sqrt[b]))])/(4*Sqrt[b]*f^2) - (d*PolyLog[2, (Sqrt[b] + Sqrt[b*Tanh[e + f*x]])/(Sqrt[-b] + Sqrt[b])])/(4*Sqrt[b]*f^2) - (d*PolyLog[2, 1 - (2*Sqrt[b])/(Sqrt[b] - Sqrt[b*Tanh[e + f*x]])])/(2*Sqrt[b]*f^2) + (I*d*PolyLog[2, 1 - (2*Sqrt[b])/(Sqrt[b] + I*Sqrt[b*Tanh[e + f*x]])])/(2*Sqrt[b]*f^2)}
{1/((c + d*x)^1*Sqrt[b*Tanh[e + f*x]]), x, 0, Unintegrable[1/((c + d*x)*Sqrt[b*Tanh[e + f*x]]), x]}


{(c + d*x)^2/(b*Tanh[e + f*x])^(3/2), x, 1, Unintegrable[(c + d*x)^2/(b*Tanh[e + f*x])^(3/2), x], -((2*(c + d*x)^2)/(b*f*Sqrt[b*Tanh[e + f*x]])) + (4*d*Unintegrable[(c + d*x)/Sqrt[b*Tanh[e + f*x]], x])/(b*f) + Unintegrable[(c + d*x)^2*Sqrt[b*Tanh[e + f*x]], x]/b^2}
{(c + d*x)^1/(b*Tanh[e + f*x])^(3/2), x, 6, (2*d*ArcTan[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(b^(3/2)*f^2) + (2*d*ArcTanh[Sqrt[b*Tanh[e + f*x]]/Sqrt[b]])/(b^(3/2)*f^2) - (2*(c + d*x))/(b*f*Sqrt[b*Tanh[e + f*x]]) + Unintegrable[(c + d*x)*Sqrt[b*Tanh[e + f*x]], x]/b^2}
{1/((c + d*x)^1*(b*Tanh[e + f*x])^(3/2)), x, 0, Unintegrable[1/((c + d*x)*(b*Tanh[e + f*x])^(3/2)), x]}
...
{x^m*Tanh[a + b*x]^3, x, 0, Unintegrable[x^m*Tanh[a + b*x]^3, x]}
{x^m*Tanh[a + b*x]^2, x, 0, Unintegrable[x^m*Tanh[a + b*x]^2, x]}
{x^m*Tanh[a + b*x]^1, x, 0, Unintegrable[x^m*Tanh[a + b*x], x]}
...
{(c + d*x)^m*(a + a*Tanh[e + f*x])^2, x, 0, Unintegrable[(c + d*x)^m*(a + a*Tanh[e + f*x])^2, x]}
{(c + d*x)^m*(a + a*Tanh[e + f*x])^1, x, 0, Unintegrable[(c+d x)^m (a+a Tanh[e+f x]),x]}
...
{(c + d*x)^3*(a + b*Tanh[e + f*x]), x, 8, (a*(c + d*x)^4)/(4*d) - (b*(c + d*x)^4)/(4*d) + (b*(c + d*x)^3*Log[1 + E^(2*(e + f*x))])/f + (3*b*d*(c + d*x)^2*PolyLog[2, -E^(2*(e + f*x))])/(2*f^2) - (3*b*d^2*(c + d*x)*PolyLog[3, -E^(2*(e + f*x))])/(2*f^3) + (3*b*d^3*PolyLog[4, -E^(2*(e + f*x))])/(4*f^4)}
{(c + d*x)^2*(a + b*Tanh[e + f*x]), x, 7, (a*(c + d*x)^3)/(3*d) - (b*(c + d*x)^3)/(3*d) + (b*(c + d*x)^2*Log[1 + E^(2*(e + f*x))])/f + (b*d*(c + d*x)*PolyLog[2, -E^(2*(e + f*x))])/f^2 - (b*d^2*PolyLog[3, -E^(2*(e + f*x))])/(2*f^3)}
{(c + d*x)^1*(a + b*Tanh[e + f*x]), x, 6, (a*(c + d*x)^2)/(2*d) - (b*(c + d*x)^2)/(2*d) + (b*(c + d*x)*Log[1 + E^(2*(e + f*x))])/f + (b*d*PolyLog[2, -E^(2*(e + f*x))])/(2*f^2)}
{(a + b*Tanh[e + f*x])/(c + d*x)^1, x, 0, Unintegrable[(a + b*Tanh[e + f*x])/(c + d*x), x]}
{(a + b*Tanh[e + f*x])/(c + d*x)^2, x, 0, Unintegrable[(a + b*Tanh[e + f*x])/(c + d*x)^2, x]}
...
{(c + d*x)^2*(a + b*Tanh[e + f*x])^2, x, 13, -((b^2*(c + d*x)^2)/f) + (a^2*(c + d*x)^3)/(3*d) - (2*a*b*(c + d*x)^3)/(3*d) + (b^2*(c + d*x)^3)/(3*d) + (2*b^2*d*(c + d*x)*Log[1 + E^(2*(e + f*x))])/f^2 + (2*a*b*(c + d*x)^2*Log[1 + E^(2*(e + f*x))])/f + (b^2*d^2*PolyLog[2, -E^(2*(e + f*x))])/f^3 + (2*a*b*d*(c + d*x)*PolyLog[2, -E^(2*(e + f*x))])/f^2 - (a*b*d^2*PolyLog[3, -E^(2*(e + f*x))])/f^3 - (b^2*(c + d*x)^2*Tanh[e + f*x])/f}
{(c + d*x)^1*(a + b*Tanh[e + f*x])^2, x, 9, b^2*c*x + (1/2)*b^2*d*x^2 + (a^2*(c + d*x)^2)/(2*d) - (a*b*(c + d*x)^2)/d + (2*a*b*(c + d*x)*Log[1 + E^(2*(e + f*x))])/f + (b^2*d*Log[Cosh[e + f*x]])/f^2 + (a*b*d*PolyLog[2, -E^(2*(e + f*x))])/f^2 - (b^2*(c + d*x)*Tanh[e + f*x])/f}
{(a + b*Tanh[e + f*x])^2/(c + d*x)^1, x, 0, Unintegrable[(a + b*Tanh[e + f*x])^2/(c + d*x), x]}
{(a + b*Tanh[e + f*x])^2/(c + d*x)^2, x, 0, Unintegrable[(a + b*Tanh[e + f*x])^2/(c + d*x)^2, x]}
...
{(a + b*Tanh[e + f*x])^3/(c + d*x)^1, x, 0, Unintegrable[(a + b*Tanh[e + f*x])^3/(c + d*x), x]}
{(a + b*Tanh[e + f*x])^3/(c + d*x)^2, x, 0, Unintegrable[(a + b*Tanh[e + f*x])^3/(c + d*x)^2, x]}
...
{1/((c + d*x)^1*(a + b*Tanh[e + f*x])), x, 0, Unintegrable[1/((c + d*x)*(a + b*Tanh[e + f*x])), x]}
{1/((c + d*x)^2*(a + b*Tanh[e + f*x])), x, 0, Unintegrable[1/((c + d*x)^2*(a + b*Tanh[e + f*x])), x]}
...
{(c + d*x)^1/(a + b*Tanh[e + f*x])^2, x, 5, -((c + d*x)^2/(2*(a^2 - b^2)*d)) + (b*d - 2*a*c*f - 2*a*d*f*x)^2/(4*a*(a - b)*(a + b)^2*d*f^2) + (b*(b*d - 2*a*c*f - 2*a*d*f*x)*Log[1 + (a - b)/(E^(2*(e + f*x))*(a + b))])/((a^2 - b^2)^2*f^2) + (a*b*d*PolyLog[2, -((a - b)/(E^(2*(e + f*x))*(a + b)))])/((a^2 - b^2)^2*f^2) + (b*(c + d*x))/((a^2 - b^2)*f*(a + b*Tanh[e + f*x]))}
{1/((c + d*x)^1*(a + b*Tanh[e + f*x])^2), x, 0, Unintegrable[1/((c + d*x)*(a + b*Tanh[e + f*x])^2), x]}
{1/((c + d*x)^2*(a + b*Tanh[e + f*x])^2), x, 0, Unintegrable[1/((c + d*x)^2*(a + b*Tanh[e + f*x])^2), x]}
