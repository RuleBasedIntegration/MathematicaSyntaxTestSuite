...
{x^1*(a + b*x^2)^2*(A + B*x + C*x^2 + D*x^3), x, 4, (a^2*B*x^3)/3 + (a^2*C*x^4)/4 + (a*(2*b*B + a*D)*x^5)/5 + (a*b*C*x^6)/3 + (b*(b*B + 2*a*D)*x^7)/7 + (b^2*C*x^8)/8 + (b^2*D*x^9)/9 + (A*(a + b*x^2)^3)/(6*b)}
...
{x^1*(a + b*x^2)^3*(A + B*x + C*x^2 + D*x^3), x, 4, (a^3*B*x^3)/3 + (a^3*C*x^4)/4 + (a^2*(3*b*B + a*D)*x^5)/5 + (a^2*b*C*x^6)/2 + (3*a*b*(b*B + a*D)*x^7)/7 + (3*a*b^2*C*x^8)/8 + (b^2*(b*B + 3*a*D)*x^9)/9 + (b^3*C*x^10)/10 + (b^3*D*x^11)/11 + (A*(a + b*x^2)^4)/(8*b)}
...
{x^8*(c + d*x^2 + e*x^4 + f*x^6)/(a + b*x^2)^3, x, 8, -((a*(35*b^3*c - 63*a*b^2*d + 99*a^2*b*e - 143*a^3*f)*x)/(8*b^7)) + ((35*b^3*c - 63*a*b^2*d + 99*a^2*b*e - 143*a^3*f)*x^3)/(24*b^6) - ((35*b^3*c - 63*a*b^2*d + 99*a^2*b*e - 143*a^3*f)*x^5)/(40*a*b^5) + ((35*b^3*c - 63*a*b^2*d + 99*a^2*b*e - 143*a^3*f)*x^7)/(56*a^2*b^4) + (f*x^9)/(9*b^3) + ((c - (a*(b^2*d - a*b*e + a^2*f))/b^3)*x^9)/(4*a*(a + b*x^2)^2) - ((5*b^3*c - 9*a*b^2*d + 13*a^2*b*e - 17*a^3*f)*x^9)/(8*a^2*b^3*(a + b*x^2)) + (a^(3/2)*(35*b^3*c - 63*a*b^2*d + 99*a^2*b*e - 143*a^3*f)*ArcTan[(Sqrt[b]*x)/Sqrt[a]])/(8*b^(15/2))}
{x^6*(c + d*x^2 + e*x^4 + f*x^6)/(a + b*x^2)^3, x, 8, ((15*b^3*c - 35*a*b^2*d + 63*a^2*b*e - 99*a^3*f)*x)/(8*b^6) - ((15*b^3*c - 35*a*b^2*d + 63*a^2*b*e - 99*a^3*f)*x^3)/(24*a*b^5) + ((15*b^3*c - 35*a*b^2*d + 63*a^2*b*e - 99*a^3*f)*x^5)/(40*a^2*b^4) + (f*x^7)/(7*b^3) + ((c - (a*(b^2*d - a*b*e + a^2*f))/b^3)*x^7)/(4*a*(a + b*x^2)^2) - ((3*b^3*c - 7*a*b^2*d + 11*a^2*b*e - 15*a^3*f)*x^7)/(8*a^2*b^3*(a + b*x^2)) - (Sqrt[a]*(15*b^3*c - 35*a*b^2*d + 63*a^2*b*e - 99*a^3*f)*ArcTan[(Sqrt[b]*x)/Sqrt[a]])/(8*b^(13/2))}
{x^4*(c + d*x^2 + e*x^4 + f*x^6)/(a + b*x^2)^3, x, 8, -(((3*b^3*c - 15*a*b^2*d + 35*a^2*b*e - 63*a^3*f)*x)/(8*a*b^5)) + ((3*b^3*c - 15*a*b^2*d + 35*a^2*b*e - 63*a^3*f)*x^3)/(24*a^2*b^4) + (f*x^5)/(5*b^3) + ((c - (a*(b^2*d - a*b*e + a^2*f))/b^3)*x^5)/(4*a*(a + b*x^2)^2) - ((b^3*c - 5*a*b^2*d + 9*a^2*b*e - 13*a^3*f)*x^5)/(8*a^2*b^3*(a + b*x^2)) + ((3*b^3*c - 15*a*b^2*d + 35*a^2*b*e - 63*a^3*f)*ArcTan[(Sqrt[b]*x)/Sqrt[a]])/(8*Sqrt[a]*b^(11/2))}
{x^2*(c + d*x^2 + e*x^4 + f*x^6)/(a + b*x^2)^3, x, 7, -(((b^3*c + 3*a*b^2*d - 15*a^2*b*e + 35*a^3*f)*x)/(8*a^2*b^4)) + (f*x^3)/(3*b^3) + ((c - (a*(b^2*d - a*b*e + a^2*f))/b^3)*x^3)/(4*a*(a + b*x^2)^2) + ((b^3*c + 3*a*b^2*d - 7*a^2*b*e + 11*a^3*f)*x^3)/(8*a^2*b^3*(a + b*x^2)) + ((b^3*c + 3*a*b^2*d - 15*a^2*b*e + 35*a^3*f)*ArcTan[(Sqrt[b]*x)/Sqrt[a]])/(8*a^(3/2)*b^(9/2))}
...
{(c + d*x^2 + e*x^4 + f*x^6)/(a + b*x^2)^3/x^2, x, 4, -(c/(a^3*x)) - (((b*c)/a - d + (a*e)/b - (a^2*f)/b^2)*x)/(4*a*(a + b*x^2)^2) - (((7*b*c)/a - 3*d - (a*e)/b + (5*a^2*f)/b^2)*x)/(8*a^2*(a + b*x^2)) - ((15*b^3*c - 3*a*b^2*d - a^2*b*e - 3*a^3*f)*ArcTan[(Sqrt[b]*x)/Sqrt[a]])/(8*a^(7/2)*b^(5/2))}
...
{(c + d*x^2 + e*x^4 + f*x^6)/(x^4*Sqrt[a + b*x^2]), x, 7, -((c*Sqrt[a + b*x^2])/(3*a*x^3)) + ((2*b*c - 3*a*d)*Sqrt[a + b*x^2])/(3*a^2*x) + (f*x*Sqrt[a + b*x^2])/(2*b) + ((2*b*e - a*f)*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/(2*b^(3/2))}
{(c + d*x^2 + e*x^4 + f*x^6)/(x^6*Sqrt[a + b*x^2]), x, 7, -((c*Sqrt[a + b*x^2])/(5*a*x^5)) + ((4*b*c - 5*a*d)*Sqrt[a + b*x^2])/(15*a^2*x^3) - ((8*b^2*c - 10*a*b*d + 15*a^2*e)*Sqrt[a + b*x^2])/(15*a^3*x) + (f*ArcTanh[(Sqrt[b]*x)/Sqrt[a + b*x^2]])/Sqrt[b]}
