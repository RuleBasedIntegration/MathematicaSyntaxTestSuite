...
{x^4*(a + b*x^2)*Sqrt[-c + d*x]*Sqrt[c + d*x], x, 8, (c^4*(5*b*c^2 + 8*a*d^2)*x*Sqrt[-c + d*x]*Sqrt[c + d*x])/(128*d^6) + (c^2*(5*b*c^2 + 8*a*d^2)*x*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(64*d^6) + ((5*b*c^2 + 8*a*d^2)*x^3*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(48*d^4) + (b*x^5*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(8*d^2) - (c^6*(5*b*c^2 + 8*a*d^2)*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]])/(64*d^7)}
{x^2*(a + b*x^2)*Sqrt[-c + d*x]*Sqrt[c + d*x], x, 6, (c^2*(b*c^2 + 2*a*d^2)*x*Sqrt[-c + d*x]*Sqrt[c + d*x])/(16*d^4) + ((b*c^2 + 2*a*d^2)*x*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(8*d^4) + (b*x^3*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(6*d^2) - (c^4*(b*c^2 + 2*a*d^2)*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]])/(8*d^5)}
{x^0*(a + b*x^2)*Sqrt[-c + d*x]*Sqrt[c + d*x], x, 4, ((b*c^2 + 4*a*d^2)*x*Sqrt[-c + d*x]*Sqrt[c + d*x])/(8*d^2) + (b*x*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(4*d^2) - (c^2*(b*c^2 + 4*a*d^2)*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]])/(4*d^3)}
{(a + b*x^2)*Sqrt[-c + d*x]*Sqrt[c + d*x]/x^2, x, 4, (1/2)*(b - (2*a*d^2)/c^2)*x*Sqrt[-c + d*x]*Sqrt[c + d*x] + (a*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(c^2*x) - ((b*c^2 - 2*a*d^2)*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]])/d}
{(a + b*x^2)*Sqrt[-c + d*x]*Sqrt[c + d*x]/x^4, x, 5, -((b*Sqrt[-c + d*x]*Sqrt[c + d*x])/x) + (a*(-c + d*x)^(3/2)*(c + d*x)^(3/2))/(3*c^2*x^3) + 2*b*d*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]]}
...
{x^0*(a + b*x^2)/(Sqrt[-c + d*x]*Sqrt[c + d*x]), x, 3, (b*x*Sqrt[-c + d*x]*Sqrt[c + d*x])/(2*d^2) + ((b*c^2 + 2*a*d^2)*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]])/d^3}
{(a + b*x^2)/(x^1*Sqrt[-c + d*x]*Sqrt[c + d*x]), x, 3, (b*Sqrt[-c + d*x]*Sqrt[c + d*x])/d^2 + (a*ArcTan[(Sqrt[-c + d*x]*Sqrt[c + d*x])/c])/c}
{(a + b*x^2)/(x^2*Sqrt[-c + d*x]*Sqrt[c + d*x]), x, 3, (a*Sqrt[-c + d*x]*Sqrt[c + d*x])/(c^2*x) + (2*b*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]])/d}
...
{x^0*(a + b*x^2)/((-c + d*x)^(3/2)*(c + d*x)^(3/2)), x, 3, -(((a/c^2 + b/d^2)*x)/(Sqrt[-c + d*x]*Sqrt[c + d*x])) + (2*b*ArcTanh[Sqrt[-c + d*x]/Sqrt[c + d*x]])/d^3}
