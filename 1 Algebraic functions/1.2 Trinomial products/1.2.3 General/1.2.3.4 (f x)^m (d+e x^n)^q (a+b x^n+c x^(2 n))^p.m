...
{x^1*(b + 2*c*x^2)*(a + b*x^2 + c*x^4)^13, x, 1, (1/28)*(a + b*x^2 + c*x^4)^14}
{x^2*(b + 2*c*x^3)*(a + b*x^3 + c*x^6)^13, x, 1, (1/42)*(a + b*x^3 + c*x^6)^14}
...
{x^1*(b + 2*c*x^2)*(b*x^2 + c*x^4)^13, x, 1, (1/28)*(b*x^2 + c*x^4)^14}
{x^2*(b + 2*c*x^3)*(b*x^3 + c*x^6)^13, x, 1, (1/42)*(b*x^3 + c*x^6)^14}
...
{x^1*(b + 2*c*x^2)/(a + b*x^2 + c*x^4), x, 1, (1/2)*Log[a + b*x^2 + c*x^4]}
{x^2*(b + 2*c*x^3)/(a + b*x^3 + c*x^6), x, 1, (1/3)*Log[a + b*x^3 + c*x^6]}
{x^(n - 1)*(b + 2*c*x^n)/(a + b*x^n + c*x^(2*n)), x, 2, Log[a + b*x^n + c*x^(2*n)]/n}


{x^0*(b + 2*c*x^1)/(a + b*x^1 + c*x^2)^8, x, 1, -(1/(7*(a + b*x + c*x^2)^7))}
{x^1*(b + 2*c*x^2)/(a + b*x^2 + c*x^4)^8, x, 1, -(1/(14*(a + b*x^2 + c*x^4)^7))}
...
{x^1*(b + 2*c*x^2)/(b*x^2 + c*x^4), x, 1, (1/2)*Log[b*x^2 + c*x^4]}
{x^2*(b + 2*c*x^3)/(b*x^3 + c*x^6), x, 1, (1/3)*Log[b*x^3 + c*x^6]}
{x^(n - 1)*(b + 2*c*x^n)/(b*x^n + c*x^(2*n)), x, 4, Log[x] + Log[b + c*x^n]/n}


{x^0*(b + 2*c*x^1)/(b*x^1 + c*x^2)^8, x, 1, -(1/(7*(b*x + c*x^2)^7))}
{x^1*(b + 2*c*x^2)/(b*x^2 + c*x^4)^8, x, 1, -(1/(14*(b*x^2 + c*x^4)^7))}
...
{x^1*(b + 2*c*x^2)*(a + b*x^2 + c*x^4)^p, x, 1, (a + b*x^2 + c*x^4)^(1 + p)/(2*(1 + p))}
