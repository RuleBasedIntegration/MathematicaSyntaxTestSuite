...
{(f + g*x)/((d + e*x)*Sqrt[a + c*x^4]), x, 7, ((e*f - d*g)*ArcTan[(Sqrt[-((c*d^4 + a*e^4)/(d^2*e^2))]*x)/Sqrt[a + c*x^4]])/(2*d*e*Sqrt[-((c*d^4 + a*e^4)/(d^2*e^2))]) - ((e*f - d*g)*ArcTanh[(a*e^2 + c*d^2*x^2)/(Sqrt[c*d^4 + a*e^4]*Sqrt[a + c*x^4])])/(2*Sqrt[c*d^4 + a*e^4]) + ((Sqrt[c]*d*f + Sqrt[a]*e*g)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticF[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(2*a^(1/4)*c^(1/4)*(Sqrt[c]*d^2 + Sqrt[a]*e^2)*Sqrt[a + c*x^4]) - ((Sqrt[c]*d^2 - Sqrt[a]*e^2)*(e*f - d*g)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticPi[(Sqrt[c]*d^2 + Sqrt[a]*e^2)^2/(4*Sqrt[a]*Sqrt[c]*d^2*e^2), 2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*c^(1/4)*d*e*(Sqrt[c]*d^2 + Sqrt[a]*e^2)*Sqrt[a + c*x^4])}


{(f + g*x)/((d + e*x)*Sqrt[-a + c*x^4]), x, 9, ((e*f - d*g)*ArcTanh[(a*e^2 - c*d^2*x^2)/(Sqrt[c*d^4 - a*e^4]*Sqrt[-a + c*x^4])])/(2*Sqrt[c*d^4 - a*e^4]) + (a^(1/4)*g*Sqrt[1 - (c*x^4)/a]*EllipticF[ArcSin[(c^(1/4)*x)/a^(1/4)], -1])/(c^(1/4)*e*Sqrt[-a + c*x^4]) + (a^(1/4)*(e*f - d*g)*Sqrt[1 - (c*x^4)/a]*EllipticPi[(Sqrt[a]*e^2)/(Sqrt[c]*d^2), ArcSin[(c^(1/4)*x)/a^(1/4)], -1])/(c^(1/4)*d*e*Sqrt[-a + c*x^4])}
...
{(a + c*x^4)/(d + e*x^2)^4, x, 4, ((a + (c*d^2)/e^2)*x)/(6*d*(d + e*x^2)^3) + (((5*a)/d^2 - (7*c)/e^2)*x)/(24*(d + e*x^2)^2) + ((c*d^2 + 5*a*e^2)*x)/(16*d^3*e^2*(d + e*x^2)) + ((c*d^2 + 5*a*e^2)*ArcTan[(Sqrt[e]*x)/Sqrt[d]])/(16*d^(7/2)*e^(5/2))}
...
{(a + c*x^4)^2/(d + e*x^2)^3, x, 5, (-3*c^2*d*x)/e^4 + (c^2*x^3)/(3*e^3) + ((c*d^2 + a*e^2)^2*x)/(4*d*e^4*(d + e*x^2)^2) - ((13*c*d^2 - 3*a*e^2)*(c*d^2 + a*e^2)*x)/(8*d^2*e^4*(d + e*x^2)) + ((35*c^2*d^4 + 6*a*c*d^2*e^2 + 3*a^2*e^4)*ArcTan[(Sqrt[e]*x)/Sqrt[d]])/(8*d^(5/2)*e^(9/2))}
{(a + c*x^4)^2/(d + e*x^2)^4, x, 5, (c^2*x)/e^4 + ((c*d^2 + a*e^2)^2*x)/(6*d*e^4*(d + e*x^2)^3) - ((19*c*d^2 - 5*a*e^2)*(c*d^2 + a*e^2)*x)/(24*d^2*e^4*(d + e*x^2)^2) + ((29*c^2*d^4 + 2*a*c*d^2*e^2 + 5*a^2*e^4)*x)/(16*d^3*e^4*(d + e*x^2)) - ((35*c^2*d^4 - 2*a*c*d^2*e^2 - 5*a^2*e^4)*ArcTan[(Sqrt[e]*x)/Sqrt[d]])/(16*d^(7/2)*e^(9/2))}
{(a + c*x^4)^2/(d + e*x^2)^5, x, 5, ((c*d^2 + a*e^2)^2*x)/(8*d*e^4*(d + e*x^2)^4) - ((25*c*d^2 - 7*a*e^2)*(c*d^2 + a*e^2)*x)/(48*d^2*e^4*(d + e*x^2)^3) + ((163*c^2*d^4 + 6*a*c*d^2*e^2 + 35*a^2*e^4)*x)/(192*d^3*e^4*(d + e*x^2)^2) - ((93*c^2*d^4 - 6*a*c*d^2*e^2 - 35*a^2*e^4)*x)/(128*d^4*e^4*(d + e*x^2)) + ((35*c^2*d^4 + 6*a*c*d^2*e^2 + 35*a^2*e^4)*ArcTan[(Sqrt[e]*x)/Sqrt[d]])/(128*d^(9/2)*e^(9/2))}
...
{Sqrt[1 + x^2 + x^4]/(1 + x^2)^3, x, 25, (x*Sqrt[1 + x^2 + x^4])/(4*(1 + x^2)^2) + (1/4)*ArcTan[x/Sqrt[1 + x^2 + x^4]] + ((1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticE[2*ArcTan[x], 1/4])/(4*Sqrt[1 + x^2 + x^4])}
{Sqrt[1 + x^2 + x^4]/(1 + x^2)^4, x, 28, (x*Sqrt[1 + x^2 + x^4])/(6*(1 + x^2)^3) + (x*Sqrt[1 + x^2 + x^4])/(6*(1 + x^2)^2) + (1/4)*ArcTan[x/Sqrt[1 + x^2 + x^4]] + ((1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticE[2*ArcTan[x], 1/4])/(3*Sqrt[1 + x^2 + x^4]) - ((1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticF[2*ArcTan[x], 1/4])/(8*Sqrt[1 + x^2 + x^4])}
...
{1/((1 + x^2)^3*Sqrt[1 + x^2 + x^4]), x, 11, (x*Sqrt[1 + x^2 + x^4])/(4*(1 + x^2)^2) + (1/4)*ArcTan[x/Sqrt[1 + x^2 + x^4]] + (3*(1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticE[2*ArcTan[x], 1/4])/(4*Sqrt[1 + x^2 + x^4]) - ((1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticF[2*ArcTan[x], 1/4])/(2*Sqrt[1 + x^2 + x^4])}
...
{1/((1 + x^2)^3*(1 + x^2 + x^4)^(3/2)), x, 25, -((x*(1 - x^2))/(3*Sqrt[1 + x^2 + x^4])) + (x*Sqrt[1 + x^2 + x^4])/(4*(1 + x^2)^2) - (x*Sqrt[1 + x^2 + x^4])/(3*(1 + x^2)) + (3/4)*ArcTan[x/Sqrt[1 + x^2 + x^4]] + (19*(1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticE[2*ArcTan[x], 1/4])/(12*Sqrt[1 + x^2 + x^4]) - (5*(1 + x^2)*Sqrt[(1 + x^2 + x^4)/(1 + x^2)^2]*EllipticF[2*ArcTan[x], 1/4])/(4*Sqrt[1 + x^2 + x^4])}
...
{Sqrt[2 + x^2 - x^4]/(7 + 5*x^2)^3, x, 20, (x*Sqrt[2 + x^2 - x^4])/(28*(7 + 5*x^2)^2) - (31*x*Sqrt[2 + x^2 - x^4])/(13328*(7 + 5*x^2)) - (31*EllipticE[ArcSin[x/Sqrt[2]], -2])/66640 - (269*EllipticF[ArcSin[x/Sqrt[2]], -2])/166600 + (16601*EllipticPi[-(10/7), ArcSin[x/Sqrt[2]], -2])/2332400}
...
{(2 + x^2 - x^4)^(3/2)/(7 + 5*x^2)^2, x, 20, (-(1/75))*x*Sqrt[2 + x^2 - x^4] - (17*x*Sqrt[2 + x^2 - x^4])/(175*(7 + 5*x^2)) - (97/525)*EllipticE[ArcSin[x/Sqrt[2]], -2] + (458/875)*EllipticF[ArcSin[x/Sqrt[2]], -2] - (1241*EllipticPi[-(10/7), ArcSin[x/Sqrt[2]], -2])/6125}
{(2 + x^2 - x^4)^(3/2)/(7 + 5*x^2)^3, x, 26, -((17*x*Sqrt[2 + x^2 - x^4])/(350*(7 + 5*x^2)^2)) + (563*x*Sqrt[2 + x^2 - x^4])/(9800*(7 + 5*x^2)) + (191*EllipticE[ArcSin[x/Sqrt[2]], -2])/9800 - (1251*EllipticF[ArcSin[x/Sqrt[2]], -2])/24500 + (9879*EllipticPi[-(10/7), ArcSin[x/Sqrt[2]], -2])/343000}
...
{1/((7 + 5*x^2)^2*Sqrt[2 + x^2 - x^4]), x, 7, -((25*x*Sqrt[2 + x^2 - x^4])/(476*(7 + 5*x^2))) - (5/476)*EllipticE[ArcSin[x/Sqrt[2]], -2] - (1/238)*EllipticF[ArcSin[x/Sqrt[2]], -2] + (167*EllipticPi[-(10/7), ArcSin[x/Sqrt[2]], -2])/3332}
...
{1/((7 + 5*x^2)^2*(2 + x^2 - x^4)^(3/2)), x, 16, (x*(580 - 287*x^2))/(10404*Sqrt[2 + x^2 - x^4]) + (625*x*Sqrt[2 + x^2 - x^4])/(16184*(7 + 5*x^2)) + (5143*EllipticE[ArcSin[x/Sqrt[2]], -2])/145656 + (89*EllipticF[ArcSin[x/Sqrt[2]], -2])/24276 - (10825*EllipticPi[-(10/7), ArcSin[x/Sqrt[2]], -2])/113288}
{1/((7 + 5*x^2)^3*(2 + x^2 - x^4)^(3/2)), x, 25, (x*(9830 - 4909*x^2))/(353736*Sqrt[2 + x^2 - x^4]) + (625*x*Sqrt[2 + x^2 - x^4])/(32368*(7 + 5*x^2)^2) + (645625*x*Sqrt[2 + x^2 - x^4])/(15407168*(7 + 5*x^2)) + (3086453*EllipticE[ArcSin[x/Sqrt[2]], -2])/138664512 + (60409*EllipticF[ArcSin[x/Sqrt[2]], -2])/23110752 - (6898575*EllipticPi[-(10/7), ArcSin[x/Sqrt[2]], -2])/107850176}
...
{1/((7 + 5*x^2)^1*Sqrt[4 + 3*x^2 + x^4]), x, 2, (1/4)*Sqrt[5/77]*ArcTan[(2*Sqrt[11/35]*x)/Sqrt[4 + 3*x^2 + x^4]] - ((2 + x^2)*Sqrt[(4 + 3*x^2 + x^4)/(2 + x^2)^2]*EllipticF[2*ArcTan[x/Sqrt[2]], 1/8])/(6*Sqrt[2]*Sqrt[4 + 3*x^2 + x^4]) + (17*(2 + x^2)*Sqrt[(4 + 3*x^2 + x^4)/(2 + x^2)^2]*EllipticPi[-(9/280), 2*ArcTan[x/Sqrt[2]], 1/8])/(84*Sqrt[2]*Sqrt[4 + 3*x^2 + x^4])}
