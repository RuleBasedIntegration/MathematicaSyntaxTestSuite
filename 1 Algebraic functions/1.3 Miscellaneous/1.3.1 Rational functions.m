...
{(3 - 19*x^2 + 32*x^4 - 16*x^6)^4, x, 3, 81*x - 684*x^3 + 4590*x^5 - (149700*x^7)/7 + (634321*x^9)/9 - (1841600*x^11)/11 + (3764416*x^13)/13 - (1094656*x^15)/3 + (5633536*x^17)/17 - (4014080*x^19)/19 + (1884160*x^21)/21 - (524288*x^23)/23 + (65536*x^25)/25}
{(3 - 19*x^2 + 32*x^4 - 16*x^6)^3, x, 3, 27*x - 171*x^3 + (4113*x^5)/5 - 2605*x^7 + (16448*x^9)/3 - (84912*x^11)/11 + (93440*x^13)/13 - (21248*x^15)/5 + (24576*x^17)/17 - (4096*x^19)/19}
{(3 - 19*x^2 + 32*x^4 - 16*x^6)^2, x, 3, 9*x - 38*x^3 + (553*x^5)/5 - (1312*x^7)/7 + (544*x^9)/3 - (1024*x^11)/11 + (256*x^13)/13}
...
{x^14*(b + 2*c*x^2)*(b*x + c*x^3)^13, x, 1, (1/28)*x^14*(b*x + c*x^3)^14}
{x^28*(b + 2*c*x^3)*(b*x + c*x^4)^13, x, 1, (1/42)*x^28*(b*x + c*x^4)^14}
...
{x^(-7)*(b + 2*c*x^2)/(b*x + c*x^3)^8, x, 1, -(1/(14*x^7*(b*x + c*x^3)^7))}
{x^(-14)*(b + 2*c*x^3)/(b*x + c*x^4)^8, x, 1, -(1/(21*x^14*(b*x + c*x^4)^7))}
...
{x^7*(b + 3*d*x^2)*(b + d*x^2)^7, x, 1, (1/8)*x^8*(b + d*x^2)^8}
...
{x^7*(2*c*x + 3*d*x^2)*(c*x + d*x^2)^7, x, 1, (1/8)*x^8*(c*x + d*x^2)^8}
{x^14*(2*c*x + 3*d*x^2)*(c + d*x)^7, x, 1, (x^(2 + 2*7)*(c + d*x)^8)/8}

{x*(2*c + 3*d*x)*(a + c*x^2 + d*x^3)^7, x, 1, (a + c*x^2 + d*x^3)^8/8}
{x*(2*c + 3*d*x)*(c*x^2 + d*x^3)^7, x, 1, (1/8)*(c*x^2 + d*x^3)^8}
...
{(2 + x - 4*x^2 + 2*x^3)/(1 - x + x^2 - x^3 + x^4), x, 3, (1/2)*(1 + Sqrt[5])*Log[2 - (1 - Sqrt[5])*x + 2*x^2] + (1/2)*(1 - Sqrt[5])*Log[2 - (1 + Sqrt[5])*x + 2*x^2]}
...
{((a + b*x + c*x^2 + d*x^3)^p*( 0*a + b*( 1 + p)*x + c*(2 + 2*p)*x^2 + d*(3 + 3*p)*x^3))/x^1, x, 1, (a + b*x + c*x^2 + d*x^3)^(1 + p)/x^0}
