...
{1/((d + e*x)^3*Sqrt[a + c*x^4]), x, 36, (-3*Sqrt[c]*e^2*x*Sqrt[a + c*x^4])/(2*d*(c*d^4 + a*e^4)*(Sqrt[a] + Sqrt[c]*x^2)) + (3*Sqrt[c]*e^2*(3*c*d^4 + a*e^4)*x*Sqrt[a + c*x^4])/(2*d*(c*d^4 + a*e^4)^2*(Sqrt[a] + Sqrt[c]*x^2)) - (d^2*e^3*Sqrt[a + c*x^4])/((c*d^4 + a*e^4)*(d^2 - e^2*x^2)^2) + (d*e^4*x*Sqrt[a + c*x^4])/((c*d^4 + a*e^4)*(d^2 - e^2*x^2)^2) - (9*c*d^4*e^3*Sqrt[a + c*x^4])/(4*(c*d^4 + a*e^4)^2*(d^2 - e^2*x^2)) - (e^3*(c*d^4 - 2*a*e^4)*Sqrt[a + c*x^4])/(4*(c*d^4 + a*e^4)^2*(d^2 - e^2*x^2)) - (3*e^4*x*Sqrt[a + c*x^4])/(2*d*(c*d^4 + a*e^4)*(d^2 - e^2*x^2)) + (3*e^4*(3*c*d^4 + a*e^4)*x*Sqrt[a + c*x^4])/(2*d*(c*d^4 + a*e^4)^2*(d^2 - e^2*x^2)) + (3*(3*c*d^4 + a*e^4)*ArcTan[(Sqrt[-((c*d^4 + a*e^4)/(d^2*e^2))]*x)/Sqrt[a + c*x^4]])/(4*d^5*e^2*(-((c*d^4 + a*e^4)/(d^2*e^2)))^(3/2)) + (3*(5*c^2*d^8 + 2*a*c*d^4*e^4 + a^2*e^8)*ArcTan[(Sqrt[-((c*d^4 + a*e^4)/(d^2*e^2))]*x)/Sqrt[a + c*x^4]])/(4*d^3*(c*d^4 + a*e^4)^2*Sqrt[-((c*d^4 + a*e^4)/(d^2*e^2))]) + (3*a*c*d^2*e^5*ArcTanh[(a*e^2 + c*d^2*x^2)/(Sqrt[c*d^4 + a*e^4]*Sqrt[a + c*x^4])])/(4*(c*d^4 + a*e^4)^(5/2)) - (3*c*d^2*e*(2*c*d^4 - a*e^4)*ArcTanh[(a*e^2 + c*d^2*x^2)/(Sqrt[c*d^4 + a*e^4]*Sqrt[a + c*x^4])])/(4*(c*d^4 + a*e^4)^(5/2)) + (3*a^(1/4)*c^(1/4)*e^2*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticE[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(2*d*(c*d^4 + a*e^4)*Sqrt[a + c*x^4]) - (3*a^(1/4)*c^(1/4)*e^2*(3*c*d^4 + a*e^4)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticE[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(2*d*(c*d^4 + a*e^4)^2*Sqrt[a + c*x^4]) + (3*a^(1/4)*c^(1/4)*((Sqrt[c]*d^2)/Sqrt[a] - e^2)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticF[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(4*d*(c*d^4 + a*e^4)*Sqrt[a + c*x^4]) - (3*c^(1/4)*(3*c*d^4 + a*e^4)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticF[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*d*(Sqrt[c]*d^2 + Sqrt[a]*e^2)*(c*d^4 + a*e^4)*Sqrt[a + c*x^4]) - (c^(1/4)*(7*c^(3/2)*d^6 - 9*Sqrt[a]*c*d^4*e^2 + a*Sqrt[c]*d^2*e^4 - 3*a^(3/2)*e^6)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticF[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*d*(c*d^4 + a*e^4)^2*Sqrt[a + c*x^4]) + (3*c^(1/4)*(5*c^2*d^8 + 2*a*c*d^4*e^4 + a^2*e^8)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticF[2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(4*a^(1/4)*d*(Sqrt[c]*d^2 + Sqrt[a]*e^2)*(c*d^4 + a*e^4)^2*Sqrt[a + c*x^4]) + (3*(Sqrt[c]*d^2 - Sqrt[a]*e^2)*(3*c*d^4 + a*e^4)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticPi[(Sqrt[c]*d^2 + Sqrt[a]*e^2)^2/(4*Sqrt[a]*Sqrt[c]*d^2*e^2), 2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*c^(1/4)*d^3*(Sqrt[c]*d^2 + Sqrt[a]*e^2)*(c*d^4 + a*e^4)*Sqrt[a + c*x^4]) - (3*(Sqrt[c]*d^2 - Sqrt[a]*e^2)*(5*c^2*d^8 + 2*a*c*d^4*e^4 + a^2*e^8)*(Sqrt[a] + Sqrt[c]*x^2)*Sqrt[(a + c*x^4)/(Sqrt[a] + Sqrt[c]*x^2)^2]*EllipticPi[(Sqrt[c]*d^2 + Sqrt[a]*e^2)^2/(4*Sqrt[a]*Sqrt[c]*d^2*e^2), 2*ArcTan[(c^(1/4)*x)/a^(1/4)], 1/2])/(8*a^(1/4)*c^(1/4)*d^3*(Sqrt[c]*d^2 + Sqrt[a]*e^2)*(c*d^4 + a*e^4)^2*Sqrt[a + c*x^4])}
...
{(d + e*x + f*Sqrt[a + e^2/f^2*x^2])^(5/2), x, 8, (5*a*d*f^2*Sqrt[d + e*x + f*Sqrt[a + (e^2*x^2)/f^2]])/(2*e) + (5*a*f^2*(d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(3/2))/(6*e) + (a*f^2*(d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(5/2))/(2*d*e) + (d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(7/2)/(7*e) - (a*f^2*(d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(7/2))/(2*d*e*(e*x + f*Sqrt[a + (e^2*x^2)/f^2])) - (5*a*d^(3/2)*f^2*ArcTanh[Sqrt[d + e*x + f*Sqrt[a + (e^2*x^2)/f^2]]/Sqrt[d]])/(2*e)}
{(d + e*x + f*Sqrt[a + e^2/f^2*x^2])^(3/2), x, 8, (3*a*f^2*Sqrt[d + e*x + f*Sqrt[a + (e^2*x^2)/f^2]])/(2*e) + (a*f^2*(d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(3/2))/(2*d*e) + (d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(5/2)/(5*e) - (a*f^2*(d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(5/2))/(2*d*e*(e*x + f*Sqrt[a + (e^2*x^2)/f^2])) - (3*a*Sqrt[d]*f^2*ArcTanh[Sqrt[d + e*x + f*Sqrt[a + (e^2*x^2)/f^2]]/Sqrt[d]])/(2*e)}
{(d + e*x + f*Sqrt[a + e^2/f^2*x^2])^(1/2), x, 7, (a*f^2*Sqrt[d + e*x + f*Sqrt[a + (e^2*x^2)/f^2]])/(2*d*e) + (d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(3/2)/(3*e) - (a*f^2*(d + e*x + f*Sqrt[a + (e^2*x^2)/f^2])^(3/2))/(2*d*e*(e*x + f*Sqrt[a + (e^2*x^2)/f^2])) - (a*f^2*ArcTanh[Sqrt[d + e*x + f*Sqrt[a + (e^2*x^2)/f^2]]/Sqrt[d]])/(2*Sqrt[d]*e)}
...
{(d + e*x + f*Sqrt[a + b*x + e^2/f^2*x^2])^(5/2), x, 8, (5*f^2*(2*d*e - b*f^2)*(4*a*e^2 - b^2*f^2)*Sqrt[d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2]])/(16*e^4) + (5*f^2*(4*a*e^2 - b^2*f^2)*(d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(3/2))/(24*e^3) + (f^2*(4*a*e^2 - b^2*f^2)*(d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(5/2))/(4*e^2*(2*d*e - b*f^2)) + (d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(7/2)/(7*e) - (f^2*(4*a*e - (b^2*f^2)/e)*(d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(7/2))/(2*(2*d*e - b*f^2)*(b*f^2 + 2*e*(e*x + f*Sqrt[a + (x*(b*f^2 + e^2*x))/f^2]))) - (5*f^2*(2*d*e - b*f^2)^(3/2)*(4*a*e^2 - b^2*f^2)*ArcTanh[(Sqrt[2]*Sqrt[e]*Sqrt[d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2]])/Sqrt[2*d*e - b*f^2]])/(16*Sqrt[2]*e^(9/2))}
{(d + e*x + f*Sqrt[a + b*x + e^2/f^2*x^2])^(3/2), x, 8, (3*f^2*(4*a*e^2 - b^2*f^2)*Sqrt[d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2]])/(8*e^3) + (f^2*(4*a*e^2 - b^2*f^2)*(d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(3/2))/(4*e^2*(2*d*e - b*f^2)) + (d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(5/2)/(5*e) - (f^2*(4*a*e - (b^2*f^2)/e)*(d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(5/2))/(2*(2*d*e - b*f^2)*(b*f^2 + 2*e*(e*x + f*Sqrt[a + (x*(b*f^2 + e^2*x))/f^2]))) - (3*f^2*Sqrt[2*d*e - b*f^2]*(4*a*e^2 - b^2*f^2)*ArcTanh[(Sqrt[2]*Sqrt[e]*Sqrt[d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2]])/Sqrt[2*d*e - b*f^2]])/(8*Sqrt[2]*e^(7/2))}
{(d + e*x + f*Sqrt[a + b*x + e^2/f^2*x^2])^(1/2), x, 7, (f^2*(4*a*e^2 - b^2*f^2)*Sqrt[d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2]])/(4*e^2*(2*d*e - b*f^2)) + (d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(3/2)/(3*e) - (f^2*(4*a*e - (b^2*f^2)/e)*(d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2])^(3/2))/(2*(2*d*e - b*f^2)*(b*f^2 + 2*e*(e*x + f*Sqrt[a + (x*(b*f^2 + e^2*x))/f^2]))) - (f^2*(4*a*e^2 - b^2*f^2)*ArcTanh[(Sqrt[2]*Sqrt[e]*Sqrt[d + e*x + f*Sqrt[a + b*x + (e^2*x^2)/f^2]])/Sqrt[2*d*e - b*f^2]])/(4*Sqrt[2]*e^(5/2)*Sqrt[2*d*e - b*f^2])}
...
{(1 + x^(7/2))/(1 - x^2), x, 7, -2*Sqrt[x] - (2*x^(5/2))/5 + ArcTan[Sqrt[x]] - Log[1 - Sqrt[x]] + (1/2)*Log[1 + x]}
