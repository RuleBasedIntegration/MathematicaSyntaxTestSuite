...
{(Cos[a + b*x]^5 - Sin[a + b*x]^5)/(Cos[a + b*x]^5 + Sin[a + b*x]^5), x, 7, Log[Cos[a + b*x]]/b + Log[1 + Tan[a + b*x]]/(5*b) + ((1 + Sqrt[5])*Log[2 - (1 - Sqrt[5])*Tan[a + b*x] + 2*Tan[a + b*x]^2])/(5*b) + ((1 - Sqrt[5])*Log[2 - (1 + Sqrt[5])*Tan[a + b*x] + 2*Tan[a + b*x]^2])/(5*b)}
