...
{Cot[a + b*x]/x, x, 0, Unintegrable[Cot[a + b*x]/x, x]}
{Cot[a + b*x]/x^2, x, 0, Unintegrable[Cot[a + b*x]/x^2, x]}
...
{Cot[a + b*x]^2/x, x, 0, Unintegrable[Cot[a + b*x]^2/x, x]}
{Cot[a + b*x]^2/x^2, x, 0, Unintegrable[Cot[a + b*x]^2/x^2, x]}
...
{Cot[a + b*x]^3/x, x, 0, Unintegrable[Cot[a + b*x]^3/x, x]}
{Cot[a + b*x]^3/x^2, x, 0, Unintegrable[Cot[a + b*x]^3/x^2, x]}
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (c+d x)^m (a+I a Cot[e+f x])^n*)
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (c+d x)^m (a+I a Cot[e+f x])^n with m symbolic*)


{(c + d*x)^m*(a + I*a*Cot[e + f*x])^2, x, 0, Unintegrable[(c + d*x)^m*(a + I*a*Cot[e + f*x])^2, x]}
{(c + d*x)^m*(a + I*a*Cot[e + f*x])^1, x, 0, Unintegrable[(c + d*x)^m*(a + I*a*Cot[e + f*x]), x]}
...
{(a + b*Cot[e + f*x])/(c + d*x)^1, x, 0, Unintegrable[(a + b*Cot[e + f*x])/(c + d*x), x]}
{(a + b*Cot[e + f*x])/(c + d*x)^2, x, 0, Unintegrable[(a + b*Cot[e + f*x])/(c + d*x)^2, x]}
...
{(a + b*Cot[e + f*x])^2/(c + d*x)^1, x, 0, Unintegrable[(a + b*Cot[e + f*x])^2/(c + d*x), x]}
{(a + b*Cot[e + f*x])^2/(c + d*x)^2, x, 0, Unintegrable[(a + b*Cot[e + f*x])^2/(c + d*x)^2, x]}
...
{(a + b*Cot[e + f*x])^3/(c + d*x)^1, x, 0, Unintegrable[(a + b*Cot[e + f*x])^3/(c + d*x), x]}
{(a + b*Cot[e + f*x])^3/(c + d*x)^2, x, 0, Unintegrable[(a + b*Cot[e + f*x])^3/(c + d*x)^2, x]}
...
{(c + d*x)^3/(a + b*Cot[e + f*x]), x, 6, (c + d*x)^4/(4*(a - I*b)*d) - (b*(c + d*x)^3*Log[1 - ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/((a^2 + b^2)*f) + (3*I*b*d*(c + d*x)^2*PolyLog[2, ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/(2*(a^2 + b^2)*f^2) - (3*b*d^2*(c + d*x)*PolyLog[3, ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/(2*(a^2 + b^2)*f^3) - (3*I*b*d^3*PolyLog[4, ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/(4*(a^2 + b^2)*f^4)}
{(c + d*x)^2/(a + b*Cot[e + f*x]), x, 5, (c + d*x)^3/(3*(a - I*b)*d) - (b*(c + d*x)^2*Log[1 - ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/((a^2 + b^2)*f) + (I*b*d*(c + d*x)*PolyLog[2, ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/((a^2 + b^2)*f^2) - (b*d^2*PolyLog[3, ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/(2*(a^2 + b^2)*f^3)}
{(c + d*x)^1/(a + b*Cot[e + f*x]), x, 4, (c + d*x)^2/(2*(a - I*b)*d) - (b*(c + d*x)*Log[1 - ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/((a^2 + b^2)*f) + (I*b*d*PolyLog[2, ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/(2*(a^2 + b^2)*f^2)}
{1/((c + d*x)^1*(a + b*Cot[e + f*x])), x, 0, Unintegrable[1/((c + d*x)*(a + b*Cot[e + f*x])), x]}
{1/((c + d*x)^2*(a + b*Cot[e + f*x])), x, 0, Unintegrable[1/((c + d*x)^2*(a + b*Cot[e + f*x])), x]}
...
{(c + d*x)^1/(a + b*Cot[e + f*x])^2, x, 5, -((c + d*x)^2/(2*(a^2 + b^2)*d)) + (b*d - 2*a*c*f - 2*a*d*f*x)^2/(4*a*(a - I*b)^2*(a + I*b)*d*f^2) + (b*(c + d*x))/((a^2 + b^2)*f*(a + b*Cot[e + f*x])) + (b*(b*d - 2*a*c*f - 2*a*d*f*x)*Log[1 - ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/((a^2 + b^2)^2*f^2) + (I*a*b*d*PolyLog[2, ((a + I*b)*E^(2*I*(e + f*x)))/(a - I*b)])/((a^2 + b^2)^2*f^2)}
{1/((c + d*x)^1*(a + b*Cot[e + f*x])^2), x, 0, Unintegrable[1/((c + d*x)*(a + b*Cot[e + f*x])^2), x]}
{1/((c + d*x)^2*(a + b*Cot[e + f*x])^2), x, 0, Unintegrable[1/((c + d*x)^2*(a + b*Cot[e + f*x])^2), x]}
