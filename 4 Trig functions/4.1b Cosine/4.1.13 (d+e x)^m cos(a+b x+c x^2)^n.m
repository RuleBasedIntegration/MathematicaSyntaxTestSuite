...
{Cos[1/4 + x + x^2]/x^2, x, 3, -(Cos[1/4 + x + x^2]/x) - Sqrt[2*Pi]*FresnelS[(1 + 2*x)/Sqrt[2*Pi]] - Unintegrable[Sin[1/4 + x + x^2]/x, x]}
...
{Cos[a + b*x + c*x^2]^2/x, x, 2, (1/2)*Unintegrable[Cos[2*a + 2*b*x + 2*c*x^2]/x, x] + Log[x]/2}
...
{Cos[1/4 + x + x^2]^2/x, x, 2, (1/2)*Unintegrable[Cos[1/2 + 2*x + 2*x^2]/x, x] + Log[x]/2}
{Cos[1/4 + x + x^2]^2/x^2, x, 5, -(1/(2*x)) - Cos[1/2 + 2*x + 2*x^2]/(2*x) - Sqrt[Pi]*FresnelS[(1 + 2*x)/Sqrt[Pi]] - Unintegrable[Sin[1/2 + 2*x + 2*x^2]/x, x]}
...
{Cos[a + b*x + c*x^2]^2/(d + e*x), x, 2, (1/2)*Unintegrable[Cos[2*a + 2*b*x + 2*c*x^2]/(d + e*x), x] + Log[d + e*x]/(2*e)}
