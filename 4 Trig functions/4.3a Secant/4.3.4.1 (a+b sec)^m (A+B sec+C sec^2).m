...
{Cos[c + d*x]^1*(B*Sec[c + d*x] + C*Sec[c + d*x]^2), x, 3, B*x + (C*ArcTanh[Sin[c + d*x]])/d}
{Cos[c + d*x]^2*(B*Sec[c + d*x] + C*Sec[c + d*x]^2), x, 4, C*x + (B*Sin[c + d*x])/d}
...
{(B*Sec[c + d*x] + C*Sec[c + d*x]^2)/(b*Sec[c + d*x])^(3/2), x, 6, (2*B*EllipticE[(1/2)*(c + d*x), 2])/(b*d*Sqrt[Cos[c + d*x]]*Sqrt[b*Sec[c + d*x]]) + (2*C*Sqrt[Cos[c + d*x]]*EllipticF[(1/2)*(c + d*x), 2]*Sqrt[b*Sec[c + d*x]])/(b^2*d)}
{(B*Sec[c + d*x] + C*Sec[c + d*x]^2)/(b*Sec[c + d*x])^(5/2), x, 7, (2*C*EllipticE[(1/2)*(c + d*x), 2])/(b^2*d*Sqrt[Cos[c + d*x]]*Sqrt[b*Sec[c + d*x]]) + (2*B*Sqrt[Cos[c + d*x]]*EllipticF[(1/2)*(c + d*x), 2]*Sqrt[b*Sec[c + d*x]])/(3*b^3*d) + (2*B*Sin[c + d*x])/(3*b^2*d*Sqrt[b*Sec[c + d*x]])}
{(B*Sec[c + d*x] + C*Sec[c + d*x]^2)/(b*Sec[c + d*x])^(7/2), x, 8, (6*B*EllipticE[(1/2)*(c + d*x), 2])/(5*b^3*d*Sqrt[Cos[c + d*x]]*Sqrt[b*Sec[c + d*x]]) + (2*C*Sqrt[Cos[c + d*x]]*EllipticF[(1/2)*(c + d*x), 2]*Sqrt[b*Sec[c + d*x]])/(3*b^4*d) + (2*B*Sin[c + d*x])/(5*b^2*d*(b*Sec[c + d*x])^(3/2)) + (2*C*Sin[c + d*x])/(3*b^3*d*Sqrt[b*Sec[c + d*x]])}
{(B*Sec[c + d*x] + C*Sec[c + d*x]^2)/(b*Sec[c + d*x])^(9/2), x, 9, (6*C*EllipticE[(1/2)*(c + d*x), 2])/(5*b^4*d*Sqrt[Cos[c + d*x]]*Sqrt[b*Sec[c + d*x]]) + (10*B*Sqrt[Cos[c + d*x]]*EllipticF[(1/2)*(c + d*x), 2]*Sqrt[b*Sec[c + d*x]])/(21*b^5*d) + (2*B*Sin[c + d*x])/(7*b^2*d*(b*Sec[c + d*x])^(5/2)) + (2*C*Sin[c + d*x])/(5*b^3*d*(b*Sec[c + d*x])^(3/2)) + (10*B*Sin[c + d*x])/(21*b^4*d*Sqrt[b*Sec[c + d*x]])}
