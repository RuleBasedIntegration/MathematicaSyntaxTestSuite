...
{Csc[c + d*x]*Sqrt[a + b*Sin[c + d*x]^4], x, 7, (Sqrt[-a]*ArcTan[(Sqrt[-a]*Cos[c + d*x])/Sqrt[a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4]])/(2*d) + (Sqrt[b]*Cos[c + d*x]*Sqrt[a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4])/(Sqrt[a + b]*d*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])) - (b^(1/4)*(a + b)^(3/4)*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])*Sqrt[(a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4)/((a + b)*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])^2)]*EllipticE[2*ArcTan[(b^(1/4)*Cos[c + d*x])/(a + b)^(1/4)], (1/2)*(1 + Sqrt[b]/Sqrt[a + b])])/(d*Sqrt[a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4]) - (b^(1/4)*(a + b)^(1/4)*(Sqrt[b] - Sqrt[a + b])*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])*Sqrt[(a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4)/((a + b)*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])^2)]*EllipticF[2*ArcTan[(b^(1/4)*Cos[c + d*x])/(a + b)^(1/4)], (1/2)*(1 + Sqrt[b]/Sqrt[a + b])])/(2*d*Sqrt[a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4]) - (a*b^(1/4)*(a + b)^(1/4)*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])*Sqrt[(a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4)/((a + b)*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])^2)]*EllipticF[2*ArcTan[(b^(1/4)*Cos[c + d*x])/(a + b)^(1/4)], (1/2)*(1 + Sqrt[b]/Sqrt[a + b])])/(2*(Sqrt[b] + Sqrt[a + b])*d*Sqrt[a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4]) + (a*(a + b)^(1/4)*(Sqrt[b] - Sqrt[a + b])*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])*Sqrt[(a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4)/((a + b)*(1 + (Sqrt[b]*Cos[c + d*x]^2)/Sqrt[a + b])^2)]*EllipticPi[(Sqrt[b] + Sqrt[a + b])^2/(4*Sqrt[b]*Sqrt[a + b]), 2*ArcTan[(b^(1/4)*Cos[c + d*x])/(a + b)^(1/4)], (1/2)*(1 + Sqrt[b]/Sqrt[a + b])])/(4*b^(1/4)*(Sqrt[b] + Sqrt[a + b])*d*Sqrt[a + b - 2*b*Cos[c + d*x]^2 + b*Cos[c + d*x]^4])}
