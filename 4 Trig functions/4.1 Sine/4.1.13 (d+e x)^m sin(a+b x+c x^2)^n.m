...
{Sin[a + b*x + c*x^2]/x, x, 0, Unintegrable[Sin[a + b*x + c*x^2]/x, x]}
...
{Sin[1/4 + x + x^2]/x, x, 0, Unintegrable[Sin[1/4 + x + x^2]/x, x]}
{Sin[1/4 + x + x^2]/x^2, x, 3, Sqrt[2*Pi]*FresnelC[(1 + 2*x)/Sqrt[2*Pi]] + Unintegrable[Cos[1/4 + x + x^2]/x, x] - Sin[1/4 + x + x^2]/x}
...
{Sin[a + b*x + c*x^2]^2/x, x, 2, (-(1/2))*Unintegrable[Cos[2*a + 2*b*x + 2*c*x^2]/x, x] + Log[x]/2}
...
{Sin[1/4 + x + x^2]^2/x, x, 2, (-(1/2))*Unintegrable[Cos[1/2 + 2*x + 2*x^2]/x, x] + Log[x]/2}
{Sin[1/4 + x + x^2]^2/x^2, x, 5, -(1/(2*x)) + Cos[1/2 + 2*x + 2*x^2]/(2*x) + Sqrt[Pi]*FresnelS[(1 + 2*x)/Sqrt[Pi]] + Unintegrable[Sin[1/2 + 2*x + 2*x^2]/x, x]}
...
{Sin[a + b*x + c*x^2]/(d + e*x)^1, x, 0, Unintegrable[Sin[a + b*x + c*x^2]/(d + e*x), x]}
...
{Sin[a + b*x + c*x^2]^2/(d + e*x)^1, x, 2, (-(1/2))*Unintegrable[Cos[2*a + 2*b*x + 2*c*x^2]/(d + e*x), x] + Log[d + e*x]/(2*e)}
