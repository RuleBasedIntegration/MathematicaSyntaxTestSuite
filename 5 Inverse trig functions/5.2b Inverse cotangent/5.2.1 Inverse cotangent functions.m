...
{ArcCot[Sqrt[x]]/x^1, x, 2, (-I)*PolyLog[2, -(I/Sqrt[x])] + I*PolyLog[2, I/Sqrt[x]]}
{ArcCot[Sqrt[x]]/x^2, x, 3, 1/Sqrt[x] - ArcCot[Sqrt[x]]/x + ArcTan[Sqrt[x]]}
...
{ArcCot[a + b*x]/(c + d*x^2), x, 37, (I*ArcTan[(Sqrt[d]*x)/Sqrt[c]]*(Log[-((I - a - b*x)/(a + b*x))] + Log[a + b*x] - Log[-I + a + b*x]))/(2*Sqrt[c]*Sqrt[d]) - (I*ArcTan[(Sqrt[d]*x)/Sqrt[c]]*(Log[a + b*x] - Log[I + a + b*x] + Log[(I + a + b*x)/(a + b*x)]))/(2*Sqrt[c]*Sqrt[d]) + (I*Log[-I + a + b*x]*Log[(b*(Sqrt[-c] - Sqrt[d]*x))/(b*Sqrt[-c] - (I - a)*Sqrt[d])])/(4*Sqrt[-c]*Sqrt[d]) - (I*Log[I + a + b*x]*Log[(b*(Sqrt[-c] - Sqrt[d]*x))/(b*Sqrt[-c] + (I + a)*Sqrt[d])])/(4*Sqrt[-c]*Sqrt[d]) - (I*Log[-I + a + b*x]*Log[(b*(Sqrt[-c] + Sqrt[d]*x))/(b*Sqrt[-c] + (I - a)*Sqrt[d])])/(4*Sqrt[-c]*Sqrt[d]) + (I*Log[I + a + b*x]*Log[(b*(Sqrt[-c] + Sqrt[d]*x))/(b*Sqrt[-c] - (I + a)*Sqrt[d])])/(4*Sqrt[-c]*Sqrt[d]) + (I*PolyLog[2, -((Sqrt[d]*(I - a - b*x))/(b*Sqrt[-c] - (I - a)*Sqrt[d]))])/(4*Sqrt[-c]*Sqrt[d]) - (I*PolyLog[2, (Sqrt[d]*(I - a - b*x))/(b*Sqrt[-c] + (I - a)*Sqrt[d])])/(4*Sqrt[-c]*Sqrt[d]) + (I*PolyLog[2, -((Sqrt[d]*(I + a + b*x))/(b*Sqrt[-c] - (I + a)*Sqrt[d]))])/(4*Sqrt[-c]*Sqrt[d]) - (I*PolyLog[2, (Sqrt[d]*(I + a + b*x))/(b*Sqrt[-c] + (I + a)*Sqrt[d])])/(4*Sqrt[-c]*Sqrt[d])}
{ArcCot[a + b*x]/(c + d*x), x, 5, -((ArcCot[a + b*x]*Log[2/(1 - I*(a + b*x))])/d) + (ArcCot[a + b*x]*Log[(2*b*(c + d*x))/((b*c + I*d - a*d)*(1 - I*(a + b*x)))])/d - (I*PolyLog[2, 1 - 2/(1 - I*(a + b*x))])/(2*d) + (I*PolyLog[2, 1 - (2*b*(c + d*x))/((b*c + I*d - a*d)*(1 - I*(a + b*x)))])/(2*d)}
{ArcCot[a + b*x]/(c + d/x), x, 37, Log[I - a - b*x]/(2*b*c) + (I*(a + b*x)*Log[-((I - a - b*x)/(a + b*x))])/(2*b*c) + Log[I + a + b*x]/(2*b*c) - (I*(a + b*x)*Log[(I + a + b*x)/(a + b*x)])/(2*b*c) + (I*d*Log[(c*(I - a - b*x))/(I*c - a*c + b*d)]*Log[d + c*x])/(2*c^2) - (I*d*Log[-((I - a - b*x)/(a + b*x))]*Log[d + c*x])/(2*c^2) - (I*d*Log[(c*(I + a + b*x))/((I + a)*c - b*d)]*Log[d + c*x])/(2*c^2) + (I*d*Log[(I + a + b*x)/(a + b*x)]*Log[d + c*x])/(2*c^2) - (I*d*PolyLog[2, -((b*(d + c*x))/((I + a)*c - b*d))])/(2*c^2) + (I*d*PolyLog[2, (b*(d + c*x))/(I*c - a*c + b*d)])/(2*c^2), (I*x*(Log[-((I - a - b*x)/(a + b*x))] + Log[a + b*x] - Log[-I + a + b*x]))/(2*c) - (I*(I - a - b*x)*Log[-I + a + b*x])/(2*b*c) - (I*(I + a + b*x)*Log[I + a + b*x])/(2*b*c) - (I*x*(Log[a + b*x] - Log[I + a + b*x] + Log[(I + a + b*x)/(a + b*x)]))/(2*c) - (I*d*(Log[-((I - a - b*x)/(a + b*x))] + Log[a + b*x] - Log[-I + a + b*x])*Log[d + c*x])/(2*c^2) + (I*d*(Log[a + b*x] - Log[I + a + b*x] + Log[(I + a + b*x)/(a + b*x)])*Log[d + c*x])/(2*c^2) + (I*d*Log[I + a + b*x]*Log[-((b*(d + c*x))/((I + a)*c - b*d))])/(2*c^2) - (I*d*Log[-I + a + b*x]*Log[(b*(d + c*x))/((I - a)*c + b*d)])/(2*c^2) - (I*d*PolyLog[2, (c*(I - a - b*x))/((I - a)*c + b*d)])/(2*c^2) + (I*d*PolyLog[2, (c*(I + a + b*x))/((I + a)*c - b*d)])/(2*c^2)}
