...
{(a + b*ArcCoth[c*x])*(d + e*Log[1 - c^2*x^2])/x^2, x, 8, -((c*e*(a + b*ArcCoth[c*x])^2)/b) + b*c*d*Log[x] - ((a + b*ArcCoth[c*x])*(d + e*Log[1 - c^2*x^2]))/x - (b*c*(d + e*Log[1 - c^2*x^2])^2)/(4*e) - (1/2)*b*c*e*PolyLog[2, c^2*x^2]}
...
{(a + b*ArcCoth[c*x])*(d + e*Log[1 - c^2*x^2])/x^4, x, 17, (2*c^2*e*(a + b*ArcCoth[c*x]))/(3*x) - (c^3*e*(a + b*ArcCoth[c*x])^2)/(3*b) + (1/3)*b*c^3*d*Log[x] - b*c^3*e*Log[x] + (1/3)*b*c^3*e*Log[1 - c^2*x^2] - (b*c*(1 - c^2*x^2)*(d + e*Log[1 - c^2*x^2]))/(6*x^2) - ((a + b*ArcCoth[c*x])*(d + e*Log[1 - c^2*x^2]))/(3*x^3) - (b*c^3*(d + e*Log[1 - c^2*x^2])^2)/(12*e) - (1/6)*b*c^3*e*PolyLog[2, c^2*x^2]}
