...
(* ::Title::Closed:: *)
(*Integrands of the form (d x)^m (a+b ArcTanh[c x])^p*)


(* ::Section::Closed:: *)
(*Integrands of the form x^m (a+b ArcTanh[c x])^p*)


{x^5*(a + b*ArcTanh[c*x]), x, 4, (b*x)/(6*c^5) + (b*x^3)/(18*c^3) + (b*x^5)/(30*c) - (b*ArcTanh[c*x])/(6*c^6) + (1/6)*x^6*(a + b*ArcTanh[c*x])}
{x^4*(a + b*ArcTanh[c*x]), x, 4, (b*x^2)/(10*c^3) + (b*x^4)/(20*c) + (1/5)*x^5*(a + b*ArcTanh[c*x]) + (b*Log[1 - c^2*x^2])/(10*c^5)}
{x^3*(a + b*ArcTanh[c*x]), x, 4, (b*x)/(4*c^3) + (b*x^3)/(12*c) - (b*ArcTanh[c*x])/(4*c^4) + (1/4)*x^4*(a + b*ArcTanh[c*x])}
{x^2*(a + b*ArcTanh[c*x]), x, 4, (b*x^2)/(6*c) + (1/3)*x^3*(a + b*ArcTanh[c*x]) + (b*Log[1 - c^2*x^2])/(6*c^3)}
{x^1*(a + b*ArcTanh[c*x]), x, 3, (b*x)/(2*c) - (b*ArcTanh[c*x])/(2*c^2) + (1/2)*x^2*(a + b*ArcTanh[c*x])}
{x^0*(a + b*ArcTanh[c*x]), x, 3, a*x + b*x*ArcTanh[c*x] + (b*Log[1 - c^2*x^2])/(2*c)}
{(a + b*ArcTanh[c*x])/x^1, x, 1, a*Log[x] - (1/2)*b*PolyLog[2, (-c)*x] + (1/2)*b*PolyLog[2, c*x]}
{(a + b*ArcTanh[c*x])/x^2, x, 5, -((a + b*ArcTanh[c*x])/x) + b*c*Log[x] - (1/2)*b*c*Log[1 - c^2*x^2]}
{(a + b*ArcTanh[c*x])/x^3, x, 3, -((b*c)/(2*x)) + (1/2)*b*c^2*ArcTanh[c*x] - (a + b*ArcTanh[c*x])/(2*x^2)}
{(a + b*ArcTanh[c*x])/x^4, x, 4, -((b*c)/(6*x^2)) - (a + b*ArcTanh[c*x])/(3*x^3) + (1/3)*b*c^3*Log[x] - (1/6)*b*c^3*Log[1 - c^2*x^2]}
{(a + b*ArcTanh[c*x])/x^5, x, 4, -((b*c)/(12*x^3)) - (b*c^3)/(4*x) + (1/4)*b*c^4*ArcTanh[c*x] - (a + b*ArcTanh[c*x])/(4*x^4)}
{(a + b*ArcTanh[c*x])/x^6, x, 4, -((b*c)/(20*x^4)) - (b*c^3)/(10*x^2) - (a + b*ArcTanh[c*x])/(5*x^5) + (1/5)*b*c^5*Log[x] - (1/10)*b*c^5*Log[1 - c^2*x^2]}


{x^5*(a + b*ArcTanh[c*x])^2, x, 16, (a*b*x)/(3*c^5) + (4*b^2*x^2)/(45*c^4) + (b^2*x^4)/(60*c^2) + (b^2*x*ArcTanh[c*x])/(3*c^5) + (b*x^3*(a + b*ArcTanh[c*x]))/(9*c^3) + (b*x^5*(a + b*ArcTanh[c*x]))/(15*c) - (a + b*ArcTanh[c*x])^2/(6*c^6) + (1/6)*x^6*(a + b*ArcTanh[c*x])^2 + (23*b^2*Log[1 - c^2*x^2])/(90*c^6)}
{x^4*(a + b*ArcTanh[c*x])^2, x, 14, (3*b^2*x)/(10*c^4) + (b^2*x^3)/(30*c^2) - (3*b^2*ArcTanh[c*x])/(10*c^5) + (b*x^2*(a + b*ArcTanh[c*x]))/(5*c^3) + (b*x^4*(a + b*ArcTanh[c*x]))/(10*c) + (a + b*ArcTanh[c*x])^2/(5*c^5) + (1/5)*x^5*(a + b*ArcTanh[c*x])^2 - (2*b*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/(5*c^5) - (b^2*PolyLog[2, 1 - 2/(1 - c*x)])/(5*c^5)}
{x^3*(a + b*ArcTanh[c*x])^2, x, 11, (a*b*x)/(2*c^3) + (b^2*x^2)/(12*c^2) + (b^2*x*ArcTanh[c*x])/(2*c^3) + (b*x^3*(a + b*ArcTanh[c*x]))/(6*c) - (a + b*ArcTanh[c*x])^2/(4*c^4) + (1/4)*x^4*(a + b*ArcTanh[c*x])^2 + (b^2*Log[1 - c^2*x^2])/(3*c^4)}
{x^2*(a + b*ArcTanh[c*x])^2, x, 9, (b^2*x)/(3*c^2) - (b^2*ArcTanh[c*x])/(3*c^3) + (b*x^2*(a + b*ArcTanh[c*x]))/(3*c) + (a + b*ArcTanh[c*x])^2/(3*c^3) + (1/3)*x^3*(a + b*ArcTanh[c*x])^2 - (2*b*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/(3*c^3) - (b^2*PolyLog[2, 1 - 2/(1 - c*x)])/(3*c^3)}
{x^1*(a + b*ArcTanh[c*x])^2, x, 6, (a*b*x)/c + (b^2*x*ArcTanh[c*x])/c - (a + b*ArcTanh[c*x])^2/(2*c^2) + (1/2)*x^2*(a + b*ArcTanh[c*x])^2 + (b^2*Log[1 - c^2*x^2])/(2*c^2)}
{x^0*(a + b*ArcTanh[c*x])^2, x, 5, (a + b*ArcTanh[c*x])^2/c + x*(a + b*ArcTanh[c*x])^2 - (2*b*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/c - (b^2*PolyLog[2, 1 - 2/(1 - c*x)])/c}
{(a + b*ArcTanh[c*x])^2/x^1, x, 6, 2*(a + b*ArcTanh[c*x])^2*ArcTanh[1 - 2/(1 - c*x)] - b*(a + b*ArcTanh[c*x])*PolyLog[2, 1 - 2/(1 - c*x)] + b*(a + b*ArcTanh[c*x])*PolyLog[2, -1 + 2/(1 - c*x)] + (1/2)*b^2*PolyLog[3, 1 - 2/(1 - c*x)] - (1/2)*b^2*PolyLog[3, -1 + 2/(1 - c*x)]}
{(a + b*ArcTanh[c*x])^2/x^2, x, 4, c*(a + b*ArcTanh[c*x])^2 - (a + b*ArcTanh[c*x])^2/x + 2*b*c*(a + b*ArcTanh[c*x])*Log[2 - 2/(1 + c*x)] - b^2*c*PolyLog[2, -1 + 2/(1 + c*x)]}
{(a + b*ArcTanh[c*x])^2/x^3, x, 8, -((b*c*(a + b*ArcTanh[c*x]))/x) + (1/2)*c^2*(a + b*ArcTanh[c*x])^2 - (a + b*ArcTanh[c*x])^2/(2*x^2) + b^2*c^2*Log[x] - (1/2)*b^2*c^2*Log[1 - c^2*x^2]}
{(a + b*ArcTanh[c*x])^2/x^4, x, 8, -((b^2*c^2)/(3*x)) + (1/3)*b^2*c^3*ArcTanh[c*x] - (b*c*(a + b*ArcTanh[c*x]))/(3*x^2) + (1/3)*c^3*(a + b*ArcTanh[c*x])^2 - (a + b*ArcTanh[c*x])^2/(3*x^3) + (2/3)*b*c^3*(a + b*ArcTanh[c*x])*Log[2 - 2/(1 + c*x)] - (1/3)*b^2*c^3*PolyLog[2, -1 + 2/(1 + c*x)]}
{(a + b*ArcTanh[c*x])^2/x^5, x, 13, -((b^2*c^2)/(12*x^2)) - (b*c*(a + b*ArcTanh[c*x]))/(6*x^3) - (b*c^3*(a + b*ArcTanh[c*x]))/(2*x) + (1/4)*c^4*(a + b*ArcTanh[c*x])^2 - (a + b*ArcTanh[c*x])^2/(4*x^4) + (2/3)*b^2*c^4*Log[x] - (1/3)*b^2*c^4*Log[1 - c^2*x^2]}


{x^5*(a + b*ArcTanh[c*x])^3, x, 33, (19*b^3*x)/(60*c^5) + (b^3*x^3)/(60*c^3) - (19*b^3*ArcTanh[c*x])/(60*c^6) + (4*b^2*x^2*(a + b*ArcTanh[c*x]))/(15*c^4) + (b^2*x^4*(a + b*ArcTanh[c*x]))/(20*c^2) + (23*b*(a + b*ArcTanh[c*x])^2)/(30*c^6) + (b*x*(a + b*ArcTanh[c*x])^2)/(2*c^5) + (b*x^3*(a + b*ArcTanh[c*x])^2)/(6*c^3) + (b*x^5*(a + b*ArcTanh[c*x])^2)/(10*c) - (a + b*ArcTanh[c*x])^3/(6*c^6) + (1/6)*x^6*(a + b*ArcTanh[c*x])^3 - (23*b^2*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/(15*c^6) - (23*b^3*PolyLog[2, 1 - 2/(1 - c*x)])/(30*c^6)}
{x^4*(a + b*ArcTanh[c*x])^3, x, 24, (9*a*b^2*x)/(10*c^4) + (b^3*x^2)/(20*c^3) + (9*b^3*x*ArcTanh[c*x])/(10*c^4) + (b^2*x^3*(a + b*ArcTanh[c*x]))/(10*c^2) - (9*b*(a + b*ArcTanh[c*x])^2)/(20*c^5) + (3*b*x^2*(a + b*ArcTanh[c*x])^2)/(10*c^3) + (3*b*x^4*(a + b*ArcTanh[c*x])^2)/(20*c) + (a + b*ArcTanh[c*x])^3/(5*c^5) + (1/5)*x^5*(a + b*ArcTanh[c*x])^3 - (3*b*(a + b*ArcTanh[c*x])^2*Log[2/(1 - c*x)])/(5*c^5) + (b^3*Log[1 - c^2*x^2])/(2*c^5) - (3*b^2*(a + b*ArcTanh[c*x])*PolyLog[2, 1 - 2/(1 - c*x)])/(5*c^5) + (3*b^3*PolyLog[3, 1 - 2/(1 - c*x)])/(10*c^5)}
{x^3*(a + b*ArcTanh[c*x])^3, x, 18, (b^3*x)/(4*c^3) - (b^3*ArcTanh[c*x])/(4*c^4) + (b^2*x^2*(a + b*ArcTanh[c*x]))/(4*c^2) + (b*(a + b*ArcTanh[c*x])^2)/c^4 + (3*b*x*(a + b*ArcTanh[c*x])^2)/(4*c^3) + (b*x^3*(a + b*ArcTanh[c*x])^2)/(4*c) - (a + b*ArcTanh[c*x])^3/(4*c^4) + (1/4)*x^4*(a + b*ArcTanh[c*x])^3 - (2*b^2*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/c^4 - (b^3*PolyLog[2, 1 - 2/(1 - c*x)])/c^4}
{x^2*(a + b*ArcTanh[c*x])^3, x, 12, (a*b^2*x)/c^2 + (b^3*x*ArcTanh[c*x])/c^2 - (b*(a + b*ArcTanh[c*x])^2)/(2*c^3) + (b*x^2*(a + b*ArcTanh[c*x])^2)/(2*c) + (a + b*ArcTanh[c*x])^3/(3*c^3) + (1/3)*x^3*(a + b*ArcTanh[c*x])^3 - (b*(a + b*ArcTanh[c*x])^2*Log[2/(1 - c*x)])/c^3 + (b^3*Log[1 - c^2*x^2])/(2*c^3) - (b^2*(a + b*ArcTanh[c*x])*PolyLog[2, 1 - 2/(1 - c*x)])/c^3 + (b^3*PolyLog[3, 1 - 2/(1 - c*x)])/(2*c^3)}
{x^1*(a + b*ArcTanh[c*x])^3, x, 8, (3*b*(a + b*ArcTanh[c*x])^2)/(2*c^2) + (3*b*x*(a + b*ArcTanh[c*x])^2)/(2*c) - (a + b*ArcTanh[c*x])^3/(2*c^2) + (1/2)*x^2*(a + b*ArcTanh[c*x])^3 - (3*b^2*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/c^2 - (3*b^3*PolyLog[2, 1 - 2/(1 - c*x)])/(2*c^2)}
{x^0*(a + b*ArcTanh[c*x])^3, x, 5, (a + b*ArcTanh[c*x])^3/c + x*(a + b*ArcTanh[c*x])^3 - (3*b*(a + b*ArcTanh[c*x])^2*Log[2/(1 - c*x)])/c - (3*b^2*(a + b*ArcTanh[c*x])*PolyLog[2, 1 - 2/(1 - c*x)])/c + (3*b^3*PolyLog[3, 1 - 2/(1 - c*x)])/(2*c)}
{(a + b*ArcTanh[c*x])^3/x^1, x, 8, 2*(a + b*ArcTanh[c*x])^3*ArcTanh[1 - 2/(1 - c*x)] - (3/2)*b*(a + b*ArcTanh[c*x])^2*PolyLog[2, 1 - 2/(1 - c*x)] + (3/2)*b*(a + b*ArcTanh[c*x])^2*PolyLog[2, -1 + 2/(1 - c*x)] + (3/2)*b^2*(a + b*ArcTanh[c*x])*PolyLog[3, 1 - 2/(1 - c*x)] - (3/2)*b^2*(a + b*ArcTanh[c*x])*PolyLog[3, -1 + 2/(1 - c*x)] - (3/4)*b^3*PolyLog[4, 1 - 2/(1 - c*x)] + (3/4)*b^3*PolyLog[4, -1 + 2/(1 - c*x)]}
{(a + b*ArcTanh[c*x])^3/x^2, x, 5, c*(a + b*ArcTanh[c*x])^3 - (a + b*ArcTanh[c*x])^3/x + 3*b*c*(a + b*ArcTanh[c*x])^2*Log[2 - 2/(1 + c*x)] - 3*b^2*c*(a + b*ArcTanh[c*x])*PolyLog[2, -1 + 2/(1 + c*x)] - (3/2)*b^3*c*PolyLog[3, -1 + 2/(1 + c*x)]}
{(a + b*ArcTanh[c*x])^3/x^3, x, 7, (3/2)*b*c^2*(a + b*ArcTanh[c*x])^2 - (3*b*c*(a + b*ArcTanh[c*x])^2)/(2*x) + (1/2)*c^2*(a + b*ArcTanh[c*x])^3 - (a + b*ArcTanh[c*x])^3/(2*x^2) + 3*b^2*c^2*(a + b*ArcTanh[c*x])*Log[2 - 2/(1 + c*x)] - (3/2)*b^3*c^2*PolyLog[2, -1 + 2/(1 + c*x)]}
{(a + b*ArcTanh[c*x])^3/x^4, x, 14, -((b^2*c^2*(a + b*ArcTanh[c*x]))/x) + (1/2)*b*c^3*(a + b*ArcTanh[c*x])^2 - (b*c*(a + b*ArcTanh[c*x])^2)/(2*x^2) + (1/3)*c^3*(a + b*ArcTanh[c*x])^3 - (a + b*ArcTanh[c*x])^3/(3*x^3) + b^3*c^3*Log[x] - (1/2)*b^3*c^3*Log[1 - c^2*x^2] + b*c^3*(a + b*ArcTanh[c*x])^2*Log[2 - 2/(1 + c*x)] - b^2*c^3*(a + b*ArcTanh[c*x])*PolyLog[2, -1 + 2/(1 + c*x)] - (1/2)*b^3*c^3*PolyLog[3, -1 + 2/(1 + c*x)]}
{(a + b*ArcTanh[c*x])^3/x^5, x, 16, -((b^3*c^3)/(4*x)) + (1/4)*b^3*c^4*ArcTanh[c*x] - (b^2*c^2*(a + b*ArcTanh[c*x]))/(4*x^2) + b*c^4*(a + b*ArcTanh[c*x])^2 - (b*c*(a + b*ArcTanh[c*x])^2)/(4*x^3) - (3*b*c^3*(a + b*ArcTanh[c*x])^2)/(4*x) + (1/4)*c^4*(a + b*ArcTanh[c*x])^3 - (a + b*ArcTanh[c*x])^3/(4*x^4) + 2*b^2*c^4*(a + b*ArcTanh[c*x])*Log[2 - 2/(1 + c*x)] - b^3*c^4*PolyLog[2, -1 + 2/(1 + c*x)]}


(* ::Section::Closed:: *)
(*Integrands of the form (d x)^(m/2) (a+b ArcTanh[c x])^p*)


{(d*x)^(5/2)*(a + b*ArcTanh[c*x]), x, 7, (4*b*d^2*Sqrt[d*x])/(7*c^3) + (4*b*(d*x)^(5/2))/(35*c) - (2*b*d^(5/2)*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(7*c^(7/2)) + (2*(d*x)^(7/2)*(a + b*ArcTanh[c*x]))/(7*d) - (2*b*d^(5/2)*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(7*c^(7/2))}
{(d*x)^(3/2)*(a + b*ArcTanh[c*x]), x, 6, (4*b*(d*x)^(3/2))/(15*c) + (2*b*d^(3/2)*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(5*c^(5/2)) + (2*(d*x)^(5/2)*(a + b*ArcTanh[c*x]))/(5*d) - (2*b*d^(3/2)*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(5*c^(5/2))}
{(d*x)^(1/2)*(a + b*ArcTanh[c*x]), x, 6, (4*b*Sqrt[d*x])/(3*c) - (2*b*Sqrt[d]*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(3*c^(3/2)) + (2*(d*x)^(3/2)*(a + b*ArcTanh[c*x]))/(3*d) - (2*b*Sqrt[d]*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(3*c^(3/2))}
{(a + b*ArcTanh[c*x])/(d*x)^(1/2), x, 5, (2*b*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(Sqrt[c]*Sqrt[d]) + (2*Sqrt[d*x]*(a + b*ArcTanh[c*x]))/d - (2*b*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(Sqrt[c]*Sqrt[d])}
{(a + b*ArcTanh[c*x])/(d*x)^(3/2), x, 5, (2*b*Sqrt[c]*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/d^(3/2) - (2*(a + b*ArcTanh[c*x]))/(d*Sqrt[d*x]) + (2*b*Sqrt[c]*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/d^(3/2)}
{(a + b*ArcTanh[c*x])/(d*x)^(5/2), x, 6, -((4*b*c)/(3*d^2*Sqrt[d*x])) - (2*b*c^(3/2)*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(3*d^(5/2)) - (2*(a + b*ArcTanh[c*x]))/(3*d*(d*x)^(3/2)) + (2*b*c^(3/2)*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(3*d^(5/2))}
{(a + b*ArcTanh[c*x])/(d*x)^(7/2), x, 6, -((4*b*c)/(15*d^2*(d*x)^(3/2))) + (2*b*c^(5/2)*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(5*d^(7/2)) - (2*(a + b*ArcTanh[c*x]))/(5*d*(d*x)^(5/2)) + (2*b*c^(5/2)*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(5*d^(7/2))}
{(a + b*ArcTanh[c*x])/(d*x)^(9/2), x, 7, -((4*b*c)/(35*d^2*(d*x)^(5/2))) - (4*b*c^3)/(7*d^4*Sqrt[d*x]) - (2*b*c^(7/2)*ArcTan[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(7*d^(9/2)) - (2*(a + b*ArcTanh[c*x]))/(7*d*(d*x)^(7/2)) + (2*b*c^(7/2)*ArcTanh[(Sqrt[c]*Sqrt[d*x])/Sqrt[d]])/(7*d^(9/2))}


(* ::Section::Closed:: *)
(*Integrands of the form (d x)^m (a+b ArcTanh[c x])^p when m symbolic*)


{(d*x)^m*(a + b*ArcTanh[c*x])^3, x, 0, Unintegrable[(d*x)^m*(a + b*ArcTanh[c*x])^3, x]}
{(d*x)^m*(a + b*ArcTanh[c*x])^2, x, 0, Unintegrable[(d*x)^m*(a + b*ArcTanh[c*x])^2, x]}
{(d*x)^m*(a + b*ArcTanh[c*x])^1, x, 2, ((d*x)^(1 + m)*(a + b*ArcTanh[c*x]))/(d*(1 + m)) - (b*c*(d*x)^(2 + m)*Hypergeometric2F1[1, (2 + m)/2, (4 + m)/2, c^2*x^2])/(d^2*(1 + m)*(2 + m))}
{(d*x)^m/(a + b*ArcTanh[c*x])^1, x, 0, Unintegrable[(d*x)^m/(a + b*ArcTanh[c*x]), x]}
{(d*x)^m/(a + b*ArcTanh[c*x])^2, x, 0, Unintegrable[(d*x)^m/(a + b*ArcTanh[c*x])^2, x]}


(* ::Section::Closed:: *)
(*Integrands of the form (d x)^m (a + b ArcTanh[c x])^p with p symbolic*)


{(a + b*ArcTanh[c*x])^p, x, 0, Unintegrable[(a + b*ArcTanh[c*x])^p, x]}


{(d*x)^m*(a + b*ArcTanh[c*x])^p, x, 0, Unintegrable[(d*x)^m*(a + b* ArcTanh[c*x])^p, x]}
...
(* ::Section::Closed:: *)
(*Integrands of the form (d+e x)^q (a+b ArcTanh[c x])^p*)


{(d + e*x)^4*(a + b*ArcTanh[c*x]), x, 6, (b*d*e*(2*c^2*d^2 + e^2)*x)/c^3 + (b*e^2*(10*c^2*d^2 + e^2)*x^2)/(10*c^3) + (b*d*e^3*x^3)/(3*c) + (b*e^4*x^4)/(20*c) + ((d + e*x)^5*(a + b*ArcTanh[c*x]))/(5*e) + (b*(c*d + e)^5*Log[1 - c*x])/(10*c^5*e) - (b*(c*d - e)^5*Log[1 + c*x])/(10*c^5*e)}
{(d + e*x)^3*(a + b*ArcTanh[c*x]), x, 6, (b*e*(6*c^2*d^2 + e^2)*x)/(4*c^3) + (b*d*e^2*x^2)/(2*c) + (b*e^3*x^3)/(12*c) + ((d + e*x)^4*(a + b*ArcTanh[c*x]))/(4*e) + (b*(c*d + e)^4*Log[1 - c*x])/(8*c^4*e) - (b*(c*d - e)^4*Log[1 + c*x])/(8*c^4*e)}
{(d + e*x)^2*(a + b*ArcTanh[c*x]), x, 6, (b*d*e*x)/c + (b*e^2*x^2)/(6*c) + ((d + e*x)^3*(a + b*ArcTanh[c*x]))/(3*e) + (b*(c*d + e)^3*Log[1 - c*x])/(6*c^3*e) - (b*(c*d - e)^3*Log[1 + c*x])/(6*c^3*e)}
{(d + e*x)^1*(a + b*ArcTanh[c*x]), x, 6, (b*e*x)/(2*c) + ((d + e*x)^2*(a + b*ArcTanh[c*x]))/(2*e) + (b*(c*d + e)^2*Log[1 - c*x])/(4*c^2*e) - (b*(c*d - e)^2*Log[1 + c*x])/(4*c^2*e)}
{(a + b*ArcTanh[c*x])/(d + e*x)^1, x, 4, -(((a + b*ArcTanh[c*x])*Log[2/(1 + c*x)])/e) + ((a + b*ArcTanh[c*x])*Log[(2*c*(d + e*x))/((c*d + e)*(1 + c*x))])/e + (b*PolyLog[2, 1 - 2/(1 + c*x)])/(2*e) - (b*PolyLog[2, 1 - (2*c*(d + e*x))/((c*d + e)*(1 + c*x))])/(2*e)}
{(a + b*ArcTanh[c*x])/(d + e*x)^2, x, 6, -((a + b*ArcTanh[c*x])/(e*(d + e*x))) - (b*c*Log[1 - c*x])/(2*e*(c*d + e)) + (b*c*Log[1 + c*x])/(2*(c*d - e)*e) - (b*c*Log[d + e*x])/(c^2*d^2 - e^2)}
{(a + b*ArcTanh[c*x])/(d + e*x)^3, x, 4, (b*c)/(2*(c^2*d^2 - e^2)*(d + e*x)) - (a + b*ArcTanh[c*x])/(2*e*(d + e*x)^2) - (b*c^2*Log[1 - c*x])/(4*e*(c*d + e)^2) + (b*c^2*Log[1 + c*x])/(4*(c*d - e)^2*e) - (b*c^3*d*Log[d + e*x])/(c^2*d^2 - e^2)^2}
{(a + b*ArcTanh[c*x])/(d + e*x)^4, x, 4, If[$VersionNumber>=8, (b*c)/(6*(c^2*d^2 - e^2)*(d + e*x)^2) + (2*b*c^3*d)/(3*(c^2*d^2 - e^2)^2*(d + e*x)) - (a + b*ArcTanh[c*x])/(3*e*(d + e*x)^3) - (b*c^3*Log[1 - c*x])/(6*e*(c*d + e)^3) + (b*c^3*Log[1 + c*x])/(6*(c*d - e)^3*e) - (b*c^3*(3*c^2*d^2 + e^2)*Log[d + e*x])/(3*(c*d - e)^3*(c*d + e)^3), (b*c)/(6*(c^2*d^2 - e^2)*(d + e*x)^2) + (2*b*c^3*d)/(3*(c^2*d^2 - e^2)^2*(d + e*x)) - (a + b*ArcTanh[c*x])/(3*e*(d + e*x)^3) - (b*c^3*Log[1 - c*x])/(6*e*(c*d + e)^3) + (b*c^3*Log[1 + c*x])/(6*(c*d - e)^3*e) - (b*c^3*(3*c^2*d^2 + e^2)*Log[d + e*x])/(3*(c^2*d^2 - e^2)^3)]}
...
{(d + e*x)^2*(a + b*ArcTanh[c*x])^2, x, 15, (2*a*b*d*e*x)/c + (b^2*e^2*x)/(3*c^2) - (b^2*e^2*ArcTanh[c*x])/(3*c^3) + (2*b^2*d*e*x*ArcTanh[c*x])/c + (b*e^2*x^2*(a + b*ArcTanh[c*x]))/(3*c) + ((3*c^2*d^2 + e^2)*(a + b*ArcTanh[c*x])^2)/(3*c^3) - (d*(d^2 + (3*e^2)/c^2)*(a + b*ArcTanh[c*x])^2)/(3*e) + ((d + e*x)^3*(a + b*ArcTanh[c*x])^2)/(3*e) - (2*b*(3*c^2*d^2 + e^2)*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/(3*c^3) + (b^2*d*e*Log[1 - c^2*x^2])/c^2 - (b^2*(3*c^2*d^2 + e^2)*PolyLog[2, 1 - 2/(1 - c*x)])/(3*c^3)}
{(d + e*x)^1*(a + b*ArcTanh[c*x])^2, x, 12, (a*b*e*x)/c + (b^2*e*x*ArcTanh[c*x])/c + (d*(a + b*ArcTanh[c*x])^2)/c - ((d^2 + e^2/c^2)*(a + b*ArcTanh[c*x])^2)/(2*e) + ((d + e*x)^2*(a + b*ArcTanh[c*x])^2)/(2*e) - (2*b*d*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/c + (b^2*e*Log[1 - c^2*x^2])/(2*c^2) - (b^2*d*PolyLog[2, 1 - 2/(1 - c*x)])/c}
{(a + b*ArcTanh[c*x])^2/(d + e*x)^1, x, 1, -(((a + b*ArcTanh[c*x])^2*Log[2/(1 + c*x)])/e) + ((a + b*ArcTanh[c*x])^2*Log[(2*c*(d + e*x))/((c*d + e)*(1 + c*x))])/e + (b*(a + b*ArcTanh[c*x])*PolyLog[2, 1 - 2/(1 + c*x)])/e - (b*(a + b*ArcTanh[c*x])*PolyLog[2, 1 - (2*c*(d + e*x))/((c*d + e)*(1 + c*x))])/e + (b^2*PolyLog[3, 1 - 2/(1 + c*x)])/(2*e) - (b^2*PolyLog[3, 1 - (2*c*(d + e*x))/((c*d + e)*(1 + c*x))])/(2*e)}
...
{x^0*(d + c*d*x)*(a + b*ArcTanh[c*x]), x, 5, (b*d*x)/2 + (d*(1 + c*x)^2*(a + b*ArcTanh[c*x]))/(2*c) + (b*d*Log[1 - c*x])/c}
...
{x^0*(d + c*d*x)^2*(a + b*ArcTanh[c*x]), x, 5, b*d^2*x + (b*c*d^2*x^2)/6 + (d^2*(1 + c*x)^3*(a + b*ArcTanh[c*x]))/(3*c) + (4*b*d^2*Log[1 - c*x])/(3*c)}
...
{x^0*(d + c*d*x)^3*(a + b*ArcTanh[c*x]), x, 5, b*d^3*x + (b*d^3*(1 + c*x)^2)/(4*c) + (b*d^3*(1 + c*x)^3)/(12*c) + (d^3*(1 + c*x)^4*(a + b*ArcTanh[c*x]))/(4*c) + (2*b*d^3*Log[1 - c*x])/c}
...
{x^0*(d + c*d*x)^4*(a + b*ArcTanh[c*x]), x, 5, (8/5)*b*d^4*x + (2*b*d^4*(1 + c*x)^2)/(5*c) + (2*b*d^4*(1 + c*x)^3)/(15*c) + (b*d^4*(1 + c*x)^4)/(20*c) + (d^4*(1 + c*x)^5*(a + b*ArcTanh[c*x]))/(5*c) + (16*b*d^4*Log[1 - c*x])/(5*c)}
...
{x^0*(d + c*d*x)*(a + b*ArcTanh[c*x])^2, x, 10, a*b*d*x + b^2*d*x*ArcTanh[c*x] + (d*(1 + c*x)^2*(a + b*ArcTanh[c*x])^2)/(2*c) - (2*b*d*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/c + (b^2*d*Log[1 - c^2*x^2])/(2*c) - (b^2*d*PolyLog[2, 1 - 2/(1 - c*x)])/c}
...
{x^0*(d + c*d*x)^2*(a + b*ArcTanh[c*x])^2, x, 13, 2*a*b*d^2*x + (1/3)*b^2*d^2*x - (b^2*d^2*ArcTanh[c*x])/(3*c) + 2*b^2*d^2*x*ArcTanh[c*x] + (1/3)*b*c*d^2*x^2*(a + b*ArcTanh[c*x]) + (d^2*(1 + c*x)^3*(a + b*ArcTanh[c*x])^2)/(3*c) - (8*b*d^2*(a + b*ArcTanh[c*x])*Log[2/(1 - c*x)])/(3*c) + (b^2*d^2*Log[1 - c^2*x^2])/c - (4*b^2*d^2*PolyLog[2, 1 - 2/(1 - c*x)])/(3*c)}
...
(* ::Title::Closed:: *)
(*Integrands of the form (h x)^m (d+e Log[f+g x^m]) (a+b ArcTanh[c x^n])^p*)


(* ::Section::Closed:: *)
(*Integrands of the form x^m (d+e Log[f x^m]) (a+b ArcTanh[c x^n])*)
...
{(a + b*ArcTanh[c*x])*(d + e*Log[1 - c^2*x^2])/x^2, x, 8, -((c*e*(a + b*ArcTanh[c*x])^2)/b) + b*c*d*Log[x] - ((a + b*ArcTanh[c*x])*(d + e*Log[1 - c^2*x^2]))/x - (b*c*(d + e*Log[1 - c^2*x^2])^2)/(4*e) - (1/2)*b*c*e*PolyLog[2, c^2*x^2]}
...
{(a + b*ArcTanh[c*x])*(d + e*Log[1 - c^2*x^2])/x^4, x, 17, (2*c^2*e*(a + b*ArcTanh[c*x]))/(3*x) - (c^3*e*(a + b*ArcTanh[c*x])^2)/(3*b) + (1/3)*b*c^3*d*Log[x] - b*c^3*e*Log[x] + (1/3)*b*c^3*e*Log[1 - c^2*x^2] - (b*c*(1 - c^2*x^2)*(d + e*Log[1 - c^2*x^2]))/(6*x^2) - ((a + b*ArcTanh[c*x])*(d + e*Log[1 - c^2*x^2]))/(3*x^3) - (b*c^3*(d + e*Log[1 - c^2*x^2])^2)/(12*e) - (1/6)*b*c^3*e*PolyLog[2, c^2*x^2]}
...
(* ::Title::Closed:: *)
(*Integrands of the form (d x)^m (a+b ArcTanh[c x^n])^p*)


(* ::Section::Closed:: *)
(*Integrands of the form (d x)^m (a+b ArcTanh[c x^2])^p*)


(* ::Subsection::Closed:: *)
(*Integrands of the form x^m (a+b ArcTanh[c x^2])^1*)


{x^7*(a + b*ArcTanh[c*x^2]), x, 5, (b*x^2)/(8*c^3) + (b*x^6)/(24*c) - (b*ArcTanh[c*x^2])/(8*c^4) + (1/8)*x^8*(a + b*ArcTanh[c*x^2])}
{x^5*(a + b*ArcTanh[c*x^2]), x, 4, (b*x^4)/(12*c) + (1/6)*x^6*(a + b*ArcTanh[c*x^2]) + (b*Log[1 - c^2*x^4])/(12*c^3)}
{x^3*(a + b*ArcTanh[c*x^2]), x, 4, (b*x^2)/(4*c) - (b*ArcTanh[c*x^2])/(4*c^2) + (1/4)*x^4*(a + b*ArcTanh[c*x^2])}
{x^1*(a + b*ArcTanh[c*x^2]), x, 2, (1/2)*x^2*(a + b*ArcTanh[c*x^2]) + (b*Log[1 - c^2*x^4])/(4*c)}
{(a + b*ArcTanh[c*x^2])/x^1, x, 2, a*Log[x] - (1/4)*b*PolyLog[2, (-c)*x^2] + (1/4)*b*PolyLog[2, c*x^2]}
{(a + b*ArcTanh[c*x^2])/x^3, x, 5, -((a + b*ArcTanh[c*x^2])/(2*x^2)) + b*c*Log[x] - (1/4)*b*c*Log[1 - c^2*x^4]}
{(a + b*ArcTanh[c*x^2])/x^5, x, 4, -((b*c)/(4*x^2)) + (1/4)*b*c^2*ArcTanh[c*x^2] - (a + b*ArcTanh[c*x^2])/(4*x^4)}
{(a + b*ArcTanh[c*x^2])/x^7, x, 4, -((b*c)/(12*x^4)) - (a + b*ArcTanh[c*x^2])/(6*x^6) + (1/3)*b*c^3*Log[x] - (1/12)*b*c^3*Log[1 - c^2*x^4]}

{x^4*(a + b*ArcTanh[c*x^2]), x, 5, (2*b*x^3)/(15*c) + (b*ArcTan[Sqrt[c]*x])/(5*c^(5/2)) - (b*ArcTanh[Sqrt[c]*x])/(5*c^(5/2)) + (1/5)*x^5*(a + b*ArcTanh[c*x^2])}
{x^2*(a + b*ArcTanh[c*x^2]), x, 5, (2*b*x)/(3*c) - (b*ArcTan[Sqrt[c]*x])/(3*c^(3/2)) - (b*ArcTanh[Sqrt[c]*x])/(3*c^(3/2)) + (1/3)*x^3*(a + b*ArcTanh[c*x^2])}
{x^0*(a + b*ArcTanh[c*x^2]), x, 5, a*x + (b*ArcTan[Sqrt[c]*x])/Sqrt[c] - (b*ArcTanh[Sqrt[c]*x])/Sqrt[c] + b*x*ArcTanh[c*x^2]}
{(a + b*ArcTanh[c*x^2])/x^2, x, 4, b*Sqrt[c]*ArcTan[Sqrt[c]*x] + b*Sqrt[c]*ArcTanh[Sqrt[c]*x] - (a + b*ArcTanh[c*x^2])/x}
{(a + b*ArcTanh[c*x^2])/x^4, x, 5, -((2*b*c)/(3*x)) - (1/3)*b*c^(3/2)*ArcTan[Sqrt[c]*x] + (1/3)*b*c^(3/2)*ArcTanh[Sqrt[c]*x] - (a + b*ArcTanh[c*x^2])/(3*x^3)}
{(a + b*ArcTanh[c*x^2])/x^6, x, 5, -((2*b*c)/(15*x^3)) + (1/5)*b*c^(5/2)*ArcTan[Sqrt[c]*x] + (1/5)*b*c^(5/2)*ArcTanh[Sqrt[c]*x] - (a + b*ArcTanh[c*x^2])/(5*x^5)}


(* ::Subsection::Closed:: *)
(*Integrands of the form x^m (a+b ArcTanh[c x^2])^2*)


{x^3*(a + b*ArcTanh[c*x^2])^2, x, 44, (3*a*b*x^2)/(4*c) - (b^2*x^4)/16 + (b^2*(1 - c*x^2)^2)/(32*c^2) + (b^2*(1 + c*x^2)^2)/(32*c^2) - (b^2*Log[1 - c*x^2])/(16*c^2) + (3*b^2*(1 - c*x^2)*Log[1 - c*x^2])/(8*c^2) - (1/16)*b*x^4*(2*a - b*Log[1 - c*x^2]) + (b*(1 - c*x^2)^2*(2*a - b*Log[1 - c*x^2]))/(16*c^2) - ((1 - c*x^2)*(2*a - b*Log[1 - c*x^2])^2)/(8*c^2) + ((1 - c*x^2)^2*(2*a - b*Log[1 - c*x^2])^2)/(16*c^2) - (b*(2*a - b*Log[1 - c*x^2])*Log[(1/2)*(1 + c*x^2)])/(8*c^2) - (b^2*Log[1 + c*x^2])/(16*c^2) + (1/16)*b^2*x^4*Log[1 + c*x^2] + (3*b^2*(1 + c*x^2)*Log[1 + c*x^2])/(8*c^2) - (b^2*(1 + c*x^2)^2*Log[1 + c*x^2])/(16*c^2) + (b^2*Log[(1/2)*(1 - c*x^2)]*Log[1 + c*x^2])/(8*c^2) + (1/8)*b*x^4*(2*a - b*Log[1 - c*x^2])*Log[1 + c*x^2] - (b^2*(1 + c*x^2)*Log[1 + c*x^2]^2)/(8*c^2) + (b^2*(1 + c*x^2)^2*Log[1 + c*x^2]^2)/(16*c^2) + (b^2*PolyLog[2, (1/2)*(1 - c*x^2)])/(8*c^2) + (b^2*PolyLog[2, (1/2)*(1 + c*x^2)])/(8*c^2)}
{x^1*(a + b*ArcTanh[c*x^2])^2, x, 28, -(((1 - c*x^2)*(2*a - b*Log[1 - c*x^2])^2)/(8*c)) + (b*(2*a - b*Log[1 - c*x^2])*Log[(1/2)*(1 + c*x^2)])/(4*c) + (b^2*Log[(1/2)*(1 - c*x^2)]*Log[1 + c*x^2])/(4*c) + (1/4)*b*x^2*(2*a - b*Log[1 - c*x^2])*Log[1 + c*x^2] + (b^2*(1 + c*x^2)*Log[1 + c*x^2]^2)/(8*c) - (b^2*PolyLog[2, (1/2)*(1 - c*x^2)])/(4*c) + (b^2*PolyLog[2, (1/2)*(1 + c*x^2)])/(4*c)}
{(a + b*ArcTanh[c*x^2])^2/x^1, x, 7, (a + b*ArcTanh[c*x^2])^2*ArcTanh[1 - 2/(1 - c*x^2)] - (1/2)*b*(a + b*ArcTanh[c*x^2])*PolyLog[2, 1 - 2/(1 - c*x^2)] + (1/2)*b*(a + b*ArcTanh[c*x^2])*PolyLog[2, -1 + 2/(1 - c*x^2)] + (1/4)*b^2*PolyLog[3, 1 - 2/(1 - c*x^2)] - (1/4)*b^2*PolyLog[3, -1 + 2/(1 - c*x^2)]}
{(a + b*ArcTanh[c*x^2])^2/x^3, x, 24, 2*a*b*c*Log[x] - ((1 - c*x^2)*(2*a - b*Log[1 - c*x^2])^2)/(8*x^2) - (1/4)*b*c*(2*a - b*Log[1 - c*x^2])*Log[(1/2)*(1 + c*x^2)] - (1/4)*b^2*c*Log[(1/2)*(1 - c*x^2)]*Log[1 + c*x^2] - (b*(2*a - b*Log[1 - c*x^2])*Log[1 + c*x^2])/(4*x^2) - (b^2*(1 + c*x^2)*Log[1 + c*x^2]^2)/(8*x^2) - (1/2)*b^2*c*PolyLog[2, (-c)*x^2] + (1/2)*b^2*c*PolyLog[2, c*x^2] + (1/4)*b^2*c*PolyLog[2, (1/2)*(1 - c*x^2)] - (1/4)*b^2*c*PolyLog[2, (1/2)*(1 + c*x^2)]}
{(a + b*ArcTanh[c*x^2])^2/x^5, x, 46, b^2*c^2*Log[x] - (1/8)*b^2*c^2*Log[1 - c*x^2] - (b*c*(2*a - b*Log[1 - c*x^2]))/(8*x^2) - (b*c*(1 - c*x^2)*(2*a - b*Log[1 - c*x^2]))/(8*x^2) + (1/16)*c^2*(2*a - b*Log[1 - c*x^2])^2 - (2*a - b*Log[1 - c*x^2])^2/(16*x^4) + (1/8)*b*c^2*(2*a - b*Log[1 - c*x^2])*Log[(1/2)*(1 + c*x^2)] - (1/4)*b^2*c^2*Log[1 + c*x^2] - (b^2*c*Log[1 + c*x^2])/(4*x^2) - (1/8)*b^2*c^2*Log[(1/2)*(1 - c*x^2)]*Log[1 + c*x^2] - (b*(2*a - b*Log[1 - c*x^2])*Log[1 + c*x^2])/(8*x^4) + (1/16)*b^2*c^2*Log[1 + c*x^2]^2 - (b^2*Log[1 + c*x^2]^2)/(16*x^4) - (1/8)*b^2*c^2*PolyLog[2, (1/2)*(1 - c*x^2)] - (1/8)*b^2*c^2*PolyLog[2, (1/2)*(1 + c*x^2)]}

{x^4*(a + b*ArcTanh[c*x^2])^2, x, 102, (8*b^2*x)/(15*c^2) + (2*a*b*x^3)/(15*c) - (2/25)*a*b*x^5 + (2*a*b*ArcTan[Sqrt[c]*x])/(5*c^(5/2)) - (4*b^2*ArcTan[Sqrt[c]*x])/(15*c^(5/2)) + (I*b^2*ArcTan[Sqrt[c]*x]^2)/(5*c^(5/2)) - (4*b^2*ArcTanh[Sqrt[c]*x])/(15*c^(5/2)) - (b^2*ArcTanh[Sqrt[c]*x]^2)/(5*c^(5/2)) + (2*b^2*ArcTanh[Sqrt[c]*x]*Log[2/(1 - Sqrt[c]*x)])/(5*c^(5/2)) - (2*b^2*ArcTan[Sqrt[c]*x]*Log[2/(1 - I*Sqrt[c]*x)])/(5*c^(5/2)) + (b^2*ArcTan[Sqrt[c]*x]*Log[((1 + I)*(1 - Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(5*c^(5/2)) + (2*b^2*ArcTan[Sqrt[c]*x]*Log[2/(1 + I*Sqrt[c]*x)])/(5*c^(5/2)) - (2*b^2*ArcTanh[Sqrt[c]*x]*Log[2/(1 + Sqrt[c]*x)])/(5*c^(5/2)) + (b^2*ArcTanh[Sqrt[c]*x]*Log[-((2*Sqrt[c]*(1 - Sqrt[-c]*x))/((Sqrt[-c] - Sqrt[c])*(1 + Sqrt[c]*x)))])/(5*c^(5/2)) + (b^2*ArcTanh[Sqrt[c]*x]*Log[(2*Sqrt[c]*(1 + Sqrt[-c]*x))/((Sqrt[-c] + Sqrt[c])*(1 + Sqrt[c]*x))])/(5*c^(5/2)) + (b^2*ArcTan[Sqrt[c]*x]*Log[((1 - I)*(1 + Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(5*c^(5/2)) - (b^2*x^3*Log[1 - c*x^2])/(15*c) + (1/25)*b^2*x^5*Log[1 - c*x^2] - (b^2*ArcTan[Sqrt[c]*x]*Log[1 - c*x^2])/(5*c^(5/2)) + (b*x^3*(2*a - b*Log[1 - c*x^2]))/(15*c) + (1/25)*b*x^5*(2*a - b*Log[1 - c*x^2]) - (b*ArcTanh[Sqrt[c]*x]*(2*a - b*Log[1 - c*x^2]))/(5*c^(5/2)) + (1/20)*x^5*(2*a - b*Log[1 - c*x^2])^2 + (2*b^2*x^3*Log[1 + c*x^2])/(15*c) + (1/5)*a*b*x^5*Log[1 + c*x^2] + (b^2*ArcTan[Sqrt[c]*x]*Log[1 + c*x^2])/(5*c^(5/2)) - (b^2*ArcTanh[Sqrt[c]*x]*Log[1 + c*x^2])/(5*c^(5/2)) - (1/10)*b^2*x^5*Log[1 - c*x^2]*Log[1 + c*x^2] + (1/20)*b^2*x^5*Log[1 + c*x^2]^2 + (b^2*PolyLog[2, 1 - 2/(1 - Sqrt[c]*x)])/(5*c^(5/2)) + (I*b^2*PolyLog[2, 1 - 2/(1 - I*Sqrt[c]*x)])/(5*c^(5/2)) - (I*b^2*PolyLog[2, 1 - ((1 + I)*(1 - Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(10*c^(5/2)) + (I*b^2*PolyLog[2, 1 - 2/(1 + I*Sqrt[c]*x)])/(5*c^(5/2)) + (b^2*PolyLog[2, 1 - 2/(1 + Sqrt[c]*x)])/(5*c^(5/2)) - (b^2*PolyLog[2, 1 + (2*Sqrt[c]*(1 - Sqrt[-c]*x))/((Sqrt[-c] - Sqrt[c])*(1 + Sqrt[c]*x))])/(10*c^(5/2)) - (b^2*PolyLog[2, 1 - (2*Sqrt[c]*(1 + Sqrt[-c]*x))/((Sqrt[-c] + Sqrt[c])*(1 + Sqrt[c]*x))])/(10*c^(5/2)) - (I*b^2*PolyLog[2, 1 - ((1 - I)*(1 + Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(10*c^(5/2))}
{x^2*(a + b*ArcTanh[c*x^2])^2, x, 86, (4*a*b*x)/(3*c) - (2/9)*a*b*x^3 - (2*a*b*ArcTan[Sqrt[c]*x])/(3*c^(3/2)) + (4*b^2*ArcTan[Sqrt[c]*x])/(3*c^(3/2)) - (I*b^2*ArcTan[Sqrt[c]*x]^2)/(3*c^(3/2)) - (4*b^2*ArcTanh[Sqrt[c]*x])/(3*c^(3/2)) - (b^2*ArcTanh[Sqrt[c]*x]^2)/(3*c^(3/2)) + (2*b^2*ArcTanh[Sqrt[c]*x]*Log[2/(1 - Sqrt[c]*x)])/(3*c^(3/2)) + (2*b^2*ArcTan[Sqrt[c]*x]*Log[2/(1 - I*Sqrt[c]*x)])/(3*c^(3/2)) - (b^2*ArcTan[Sqrt[c]*x]*Log[((1 + I)*(1 - Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(3*c^(3/2)) - (2*b^2*ArcTan[Sqrt[c]*x]*Log[2/(1 + I*Sqrt[c]*x)])/(3*c^(3/2)) - (2*b^2*ArcTanh[Sqrt[c]*x]*Log[2/(1 + Sqrt[c]*x)])/(3*c^(3/2)) + (b^2*ArcTanh[Sqrt[c]*x]*Log[-((2*Sqrt[c]*(1 - Sqrt[-c]*x))/((Sqrt[-c] - Sqrt[c])*(1 + Sqrt[c]*x)))])/(3*c^(3/2)) + (b^2*ArcTanh[Sqrt[c]*x]*Log[(2*Sqrt[c]*(1 + Sqrt[-c]*x))/((Sqrt[-c] + Sqrt[c])*(1 + Sqrt[c]*x))])/(3*c^(3/2)) - (b^2*ArcTan[Sqrt[c]*x]*Log[((1 - I)*(1 + Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(3*c^(3/2)) - (2*b^2*x*Log[1 - c*x^2])/(3*c) + (1/9)*b^2*x^3*Log[1 - c*x^2] + (b^2*ArcTan[Sqrt[c]*x]*Log[1 - c*x^2])/(3*c^(3/2)) + (1/9)*b*x^3*(2*a - b*Log[1 - c*x^2]) - (b*ArcTanh[Sqrt[c]*x]*(2*a - b*Log[1 - c*x^2]))/(3*c^(3/2)) + (1/12)*x^3*(2*a - b*Log[1 - c*x^2])^2 + (2*b^2*x*Log[1 + c*x^2])/(3*c) + (1/3)*a*b*x^3*Log[1 + c*x^2] - (b^2*ArcTan[Sqrt[c]*x]*Log[1 + c*x^2])/(3*c^(3/2)) - (b^2*ArcTanh[Sqrt[c]*x]*Log[1 + c*x^2])/(3*c^(3/2)) - (1/6)*b^2*x^3*Log[1 - c*x^2]*Log[1 + c*x^2] + (1/12)*b^2*x^3*Log[1 + c*x^2]^2 + (b^2*PolyLog[2, 1 - 2/(1 - Sqrt[c]*x)])/(3*c^(3/2)) - (I*b^2*PolyLog[2, 1 - 2/(1 - I*Sqrt[c]*x)])/(3*c^(3/2)) + (I*b^2*PolyLog[2, 1 - ((1 + I)*(1 - Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(6*c^(3/2)) - (I*b^2*PolyLog[2, 1 - 2/(1 + I*Sqrt[c]*x)])/(3*c^(3/2)) + (b^2*PolyLog[2, 1 - 2/(1 + Sqrt[c]*x)])/(3*c^(3/2)) - (b^2*PolyLog[2, 1 + (2*Sqrt[c]*(1 - Sqrt[-c]*x))/((Sqrt[-c] - Sqrt[c])*(1 + Sqrt[c]*x))])/(6*c^(3/2)) - (b^2*PolyLog[2, 1 - (2*Sqrt[c]*(1 + Sqrt[-c]*x))/((Sqrt[-c] + Sqrt[c])*(1 + Sqrt[c]*x))])/(6*c^(3/2)) + (I*b^2*PolyLog[2, 1 - ((1 - I)*(1 + Sqrt[c]*x))/(1 - I*Sqrt[c]*x)])/(6*c^(3/2))}
...
{(d*x)^m*(a + b*ArcTanh[c/x^2])^3, x, 0, Unintegrable[(d*x)^m*(a + b*ArcTanh[c/x^2])^3, x]}
{(d*x)^m*(a + b*ArcTanh[c/x^2])^2, x, 0, Unintegrable[(d*x)^m*(a + b*ArcTanh[c/x^2])^2, x]}
{(d*x)^m*(a + b*ArcTanh[c/x^2])^1, x, 4, ((d*x)^(1 + m)*(a + b*ArcTanh[c/x^2]))/(d*(1 + m)) - (2*b*c*d*(d*x)^(-1 + m)*Hypergeometric2F1[1, (1 - m)/4, (5 - m)/4, c^2/x^4])/(1 - m^2)}
{(d*x)^m/(a + b*ArcTanh[c/x^2])^1, x, 0, Unintegrable[(d*x)^m/(a + b*ArcTanh[c/x^2]), x]}
{(d*x)^m/(a + b*ArcTanh[c/x^2])^2, x, 0, Unintegrable[(d*x)^m/(a + b*ArcTanh[c/x^2])^2, x]}


(* ::Section::Closed:: *)
(*Integrands of the form (d x)^m (a+b ArcTanh[c x^(n/2)])^p*)


(* ::Subsection::Closed:: *)
(*Integrands of the form x^m (a+b ArcTanh[c x^(n/2)])^p*)


{x^2*ArcTanh[Sqrt[x]], x, 6, Sqrt[x]/3 + x^(3/2)/9 + x^(5/2)/15 - ArcTanh[Sqrt[x]]/3 + (1/3)*x^3*ArcTanh[Sqrt[x]]}
{x^1*ArcTanh[Sqrt[x]], x, 5, Sqrt[x]/2 + x^(3/2)/6 - ArcTanh[Sqrt[x]]/2 + (1/2)*x^2*ArcTanh[Sqrt[x]]}
{x^0*ArcTanh[Sqrt[x]], x, 4, Sqrt[x] - ArcTanh[Sqrt[x]] + x*ArcTanh[Sqrt[x]]}
{ArcTanh[Sqrt[x]]/x^1, x, 2, -PolyLog[2, -Sqrt[x]] + PolyLog[2, Sqrt[x]]}
...
(* ::Subsection::Closed:: *)
(*Integrands of the form (d x)^(m/2) (a+b ArcTanh[c x^(n/2)])^p*)
...
(* ::Subsection::Closed:: *)
(*Integrands of the form x^m (a+b ArcTanh[c x^n])^p*)


{x^2*(a + b*ArcTanh[c*x^n]), x, 2, (1/3)*x^3*(a + b*ArcTanh[c*x^n]) - (b*c*n*x^(3 + n)*Hypergeometric2F1[1, (3 + n)/(2*n), (3*(1 + n))/(2*n), c^2*x^(2*n)])/(3*(3 + n))}
{x^1*(a + b*ArcTanh[c*x^n]), x, 2, (1/2)*x^2*(a + b*ArcTanh[c*x^n]) - (b*c*n*x^(2 + n)*Hypergeometric2F1[1, (2 + n)/(2*n), (1/2)*(3 + 2/n), c^2*x^(2*n)])/(2*(2 + n))}
{x^0*(a + b*ArcTanh[c*x^n]), x, 3, a*x + b*x*ArcTanh[c*x^n] - (b*c*n*x^(1 + n)*Hypergeometric2F1[1, (1 + n)/(2*n), (1/2)*(3 + 1/n), c^2*x^(2*n)])/(1 + n)}
{(a + b*ArcTanh[c*x^n])/x^1, x, 2, a*Log[x] - (b*PolyLog[2, (-c)*x^n])/(2*n) + (b*PolyLog[2, c*x^n])/(2*n)}
{(a + b*ArcTanh[c*x^n])/x^2, x, 2, -((a + b*ArcTanh[c*x^n])/x) - (b*c*n*x^(-1 + n)*Hypergeometric2F1[1, -((1 - n)/(2*n)), (1/2)*(3 - 1/n), c^2*x^(2*n)])/(1 - n)}
{(a + b*ArcTanh[c*x^n])/x^3, x, 2, -((a + b*ArcTanh[c*x^n])/(2*x^2)) - (b*c*n*x^(-2 + n)*Hypergeometric2F1[1, (1/2)*(1 - 2/n), (1/2)*(3 - 2/n), c^2*x^(2*n)])/(2*(2 - n))}
{(a + b*ArcTanh[c*x^n])/x^4, x, 2, -((a + b*ArcTanh[c*x^n])/(3*x^3)) - (b*c*n*x^(-3 + n)*Hypergeometric2F1[1, -((3 - n)/(2*n)), -((3*(1 - n))/(2*n)), c^2*x^(2*n)])/(3*(3 - n))}


{x^1*(a + b*ArcTanh[c*x^n])^2, x, 0, Unintegrable[x*(a + b*ArcTanh[c*x^n])^2, x]}
{x^0*(a + b*ArcTanh[c*x^n])^2, x, 0, Unintegrable[(a + b*ArcTanh[c*x^n])^2, x]}
{(a + b*ArcTanh[c*x^n])^2/x^1, x, 7, (2*(a + b*ArcTanh[c*x^n])^2*ArcTanh[1 - 2/(1 - c*x^n)])/n - (b*(a + b*ArcTanh[c*x^n])*PolyLog[2, 1 - 2/(1 - c*x^n)])/n + (b*(a + b*ArcTanh[c*x^n])*PolyLog[2, -1 + 2/(1 - c*x^n)])/n + (b^2*PolyLog[3, 1 - 2/(1 - c*x^n)])/(2*n) - (b^2*PolyLog[3, -1 + 2/(1 - c*x^n)])/(2*n)}
{(a + b*ArcTanh[c*x^n])^2/x^2, x, 0, Unintegrable[(a + b*ArcTanh[c*x^n])^2/x^2, x]}
{(a + b*ArcTanh[c*x^n])^2/x^3, x, 0, Unintegrable[(a + b*ArcTanh[c*x^n])^2/x^3, x]}


{ArcTanh[a*x^n]/x, x, 2, -(PolyLog[2, (-a)*x^n]/(2*n)) + PolyLog[2, a*x^n]/(2*n)}


{ArcTanh[a*x^5]/x, x, 2, (-(1/10))*PolyLog[2, (-a)*x^5] + (1/10)*PolyLog[2, a*x^5]}


{ArcTanh[1/x], x, 3, x*ArcTanh[1/x] + (1/2)*Log[1 - x^2]}


(* ::Subsection:: *)
(*Integrands of the form (d x)^(m/2) (a+b ArcTanh[c x^n])^p*)


(* ::Subsection::Closed:: *)
(*Integrands of the form (d x)^m (a+b ArcTanh[c x^n])^p when m symbolic*)


{(d*x)^m*(a + b*ArcTanh[c*x^n])^3, x, 0, Unintegrable[(d*x)^m*(a + b*ArcTanh[c*x^n])^3, x]}
{(d*x)^m*(a + b*ArcTanh[c*x^n])^2, x, 0, Unintegrable[(d*x)^m*(a + b*ArcTanh[c*x^n])^2, x]}
{(d*x)^m*(a + b*ArcTanh[c*x^n])^1, x, 3, ((d*x)^(1 + m)*(a + b*ArcTanh[c*x^n]))/(d*(1 + m)) - (b*c*n*x^(1 + n)*(d*x)^m*Hypergeometric2F1[1, (1 + m + n)/(2*n), (1 + m + 3*n)/(2*n), c^2*x^(2*n)])/((1 + m)*(1 + m + n))}
{(d*x)^m/(a + b*ArcTanh[c*x^n])^1, x, 0, Unintegrable[(d*x)^m/(a + b*ArcTanh[c*x^n]), x]}
{(d*x)^m/(a + b*ArcTanh[c*x^n])^2, x, 0, Unintegrable[(d*x)^m/(a + b*ArcTanh[c*x^n])^2, x]}


(* ::Section::Closed:: *)
(*Integrands of the form x^m (d+e x)^q (a+b ArcTanh[c x^(1/2)])^p with c^2 d+e=0*)


{x^3*(a + b*ArcTanh[c*Sqrt[x]])/(1 - c^2*x), x, 19, -((11*b*Sqrt[x])/(6*c^7)) - (5*b*x^(3/2))/(18*c^5) - (b*x^(5/2))/(15*c^3) + (11*b*ArcTanh[c*Sqrt[x]])/(6*c^8) - (x*(a + b*ArcTanh[c*Sqrt[x]]))/c^6 - (x^2*(a + b*ArcTanh[c*Sqrt[x]]))/(2*c^4) - (x^3*(a + b*ArcTanh[c*Sqrt[x]]))/(3*c^2) - (a + b*ArcTanh[c*Sqrt[x]])^2/(b*c^8) + (2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 - c*Sqrt[x])])/c^8 + (b*PolyLog[2, 1 - 2/(1 - c*Sqrt[x])])/c^8}
{x^2*(a + b*ArcTanh[c*Sqrt[x]])/(1 - c^2*x), x, 14, -((3*b*Sqrt[x])/(2*c^5)) - (b*x^(3/2))/(6*c^3) + (3*b*ArcTanh[c*Sqrt[x]])/(2*c^6) - (x*(a + b*ArcTanh[c*Sqrt[x]]))/c^4 - (x^2*(a + b*ArcTanh[c*Sqrt[x]]))/(2*c^2) - (a + b*ArcTanh[c*Sqrt[x]])^2/(b*c^6) + (2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 - c*Sqrt[x])])/c^6 + (b*PolyLog[2, 1 - 2/(1 - c*Sqrt[x])])/c^6}
{x^1*(a + b*ArcTanh[c*Sqrt[x]])/(1 - c^2*x), x, 9, -((b*Sqrt[x])/c^3) + (b*ArcTanh[c*Sqrt[x]])/c^4 - (x*(a + b*ArcTanh[c*Sqrt[x]]))/c^2 - (a + b*ArcTanh[c*Sqrt[x]])^2/(b*c^4) + (2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 - c*Sqrt[x])])/c^4 + (b*PolyLog[2, 1 - 2/(1 - c*Sqrt[x])])/c^4}
{x^0*(a + b*ArcTanh[c*Sqrt[x]])/(1 - c^2*x), x, 5, -((a + b*ArcTanh[c*Sqrt[x]])^2/(b*c^2)) + (2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 - c*Sqrt[x])])/c^2 + (b*PolyLog[2, 1 - 2/(1 - c*Sqrt[x])])/c^2}
{(a + b*ArcTanh[c*Sqrt[x]])/(x^1*(1 - c^2*x)), x, 5, (a + b*ArcTanh[c*Sqrt[x]])^2/b + 2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2 - 2/(1 + c*Sqrt[x])] - b*PolyLog[2, -1 + 2/(1 + c*Sqrt[x])]}
{(a + b*ArcTanh[c*Sqrt[x]])/(x^2*(1 - c^2*x)), x, 9, -((b*c)/Sqrt[x]) + b*c^2*ArcTanh[c*Sqrt[x]] - (a + b*ArcTanh[c*Sqrt[x]])/x + (c^2*(a + b*ArcTanh[c*Sqrt[x]])^2)/b + 2*c^2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2 - 2/(1 + c*Sqrt[x])] - b*c^2*PolyLog[2, -1 + 2/(1 + c*Sqrt[x])]}
{(a + b*ArcTanh[c*Sqrt[x]])/(x^3*(1 - c^2*x)), x, 14, -((b*c)/(6*x^(3/2))) - (3*b*c^3)/(2*Sqrt[x]) + (3/2)*b*c^4*ArcTanh[c*Sqrt[x]] - (a + b*ArcTanh[c*Sqrt[x]])/(2*x^2) - (c^2*(a + b*ArcTanh[c*Sqrt[x]]))/x + (c^4*(a + b*ArcTanh[c*Sqrt[x]])^2)/b + 2*c^4*(a + b*ArcTanh[c*Sqrt[x]])*Log[2 - 2/(1 + c*Sqrt[x])] - b*c^4*PolyLog[2, -1 + 2/(1 + c*Sqrt[x])]}
{(a + b*ArcTanh[c*Sqrt[x]])/(x^4*(1 - c^2*x)), x, 20, -((b*c)/(15*x^(5/2))) - (5*b*c^3)/(18*x^(3/2)) - (11*b*c^5)/(6*Sqrt[x]) + (11/6)*b*c^6*ArcTanh[c*Sqrt[x]] - (a + b*ArcTanh[c*Sqrt[x]])/(3*x^3) - (c^2*(a + b*ArcTanh[c*Sqrt[x]]))/(2*x^2) - (c^4*(a + b*ArcTanh[c*Sqrt[x]]))/x + (c^6*(a + b*ArcTanh[c*Sqrt[x]])^2)/b + 2*c^6*(a + b*ArcTanh[c*Sqrt[x]])*Log[2 - 2/(1 + c*Sqrt[x])] - b*c^6*PolyLog[2, -1 + 2/(1 + c*Sqrt[x])]}


(* ::Section::Closed:: *)
(*Integrands of the form x^m (d+e x)^q (a+b ArcTanh[c x^(1/2)])^p*)


{x^2*(a + b*ArcTanh[c*Sqrt[x]])/(d + e*x), x, 20, -((b*d*Sqrt[x])/(c*e^2)) + (b*Sqrt[x])/(2*c^3*e) + (b*x^(3/2))/(6*c*e) + (b*d*ArcTanh[c*Sqrt[x]])/(c^2*e^2) - (b*ArcTanh[c*Sqrt[x]])/(2*c^4*e) - (d*x*(a + b*ArcTanh[c*Sqrt[x]]))/e^2 + (x^2*(a + b*ArcTanh[c*Sqrt[x]]))/(2*e) - (2*d^2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 + c*Sqrt[x])])/e^3 + (d^2*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/e^3 + (d^2*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/e^3 + (b*d^2*PolyLog[2, 1 - 2/(1 + c*Sqrt[x])])/e^3 - (b*d^2*PolyLog[2, 1 - (2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/(2*e^3) - (b*d^2*PolyLog[2, 1 - (2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/(2*e^3)}
{x^1*(a + b*ArcTanh[c*Sqrt[x]])/(d + e*x), x, 15, (b*Sqrt[x])/(c*e) - (b*ArcTanh[c*Sqrt[x]])/(c^2*e) + (x*(a + b*ArcTanh[c*Sqrt[x]]))/e + (2*d*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 + c*Sqrt[x])])/e^2 - (d*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/e^2 - (d*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/e^2 - (b*d*PolyLog[2, 1 - 2/(1 + c*Sqrt[x])])/e^2 + (b*d*PolyLog[2, 1 - (2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/(2*e^2) + (b*d*PolyLog[2, 1 - (2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/(2*e^2)}
{x^0*(a + b*ArcTanh[c*Sqrt[x]])/(d + e*x), x, 11, -((2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 + c*Sqrt[x])])/e) + ((a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/e + ((a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/e + (b*PolyLog[2, 1 - 2/(1 + c*Sqrt[x])])/e - (b*PolyLog[2, 1 - (2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/(2*e) - (b*PolyLog[2, 1 - (2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/(2*e)}
{(a + b*ArcTanh[c*Sqrt[x]])/(x^1*(d + e*x)), x, 15, (2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 + c*Sqrt[x])])/d - ((a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/d - ((a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/d + (a*Log[x])/d - (b*PolyLog[2, 1 - 2/(1 + c*Sqrt[x])])/d + (b*PolyLog[2, 1 - (2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/(2*d) + (b*PolyLog[2, 1 - (2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/(2*d) - (b*PolyLog[2, (-c)*Sqrt[x]])/d + (b*PolyLog[2, c*Sqrt[x]])/d}
{(a + b*ArcTanh[c*Sqrt[x]])/(x^2*(d + e*x)), x, 19, -((b*c)/(d*Sqrt[x])) + (b*c^2*ArcTanh[c*Sqrt[x]])/d - (a + b*ArcTanh[c*Sqrt[x]])/(d*x) - (2*e*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 + c*Sqrt[x])])/d^2 + (e*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/d^2 + (e*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/d^2 - (a*e*Log[x])/d^2 + (b*e*PolyLog[2, 1 - 2/(1 + c*Sqrt[x])])/d^2 - (b*e*PolyLog[2, 1 - (2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/(2*d^2) - (b*e*PolyLog[2, 1 - (2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/(2*d^2) + (b*e*PolyLog[2, (-c)*Sqrt[x]])/d^2 - (b*e*PolyLog[2, c*Sqrt[x]])/d^2}
{(a + b*ArcTanh[c*Sqrt[x]])/(x^3*(d + e*x)), x, 24, -((b*c)/(6*d*x^(3/2))) - (b*c^3)/(2*d*Sqrt[x]) + (b*c*e)/(d^2*Sqrt[x]) + (b*c^4*ArcTanh[c*Sqrt[x]])/(2*d) - (b*c^2*e*ArcTanh[c*Sqrt[x]])/d^2 - (a + b*ArcTanh[c*Sqrt[x]])/(2*d*x^2) + (e*(a + b*ArcTanh[c*Sqrt[x]]))/(d^2*x) + (2*e^2*(a + b*ArcTanh[c*Sqrt[x]])*Log[2/(1 + c*Sqrt[x])])/d^3 - (e^2*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/d^3 - (e^2*(a + b*ArcTanh[c*Sqrt[x]])*Log[(2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/d^3 + (a*e^2*Log[x])/d^3 - (b*e^2*PolyLog[2, 1 - 2/(1 + c*Sqrt[x])])/d^3 + (b*e^2*PolyLog[2, 1 - (2*c*(Sqrt[-d] - Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] - Sqrt[e])*(1 + c*Sqrt[x]))])/(2*d^3) + (b*e^2*PolyLog[2, 1 - (2*c*(Sqrt[-d] + Sqrt[e]*Sqrt[x]))/((c*Sqrt[-d] + Sqrt[e])*(1 + c*Sqrt[x]))])/(2*d^3) - (b*e^2*PolyLog[2, (-c)*Sqrt[x]])/d^3 + (b*e^2*PolyLog[2, c*Sqrt[x]])/d^3}
